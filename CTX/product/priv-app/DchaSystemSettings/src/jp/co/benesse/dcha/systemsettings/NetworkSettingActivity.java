...
public class NetworkSettingActivity extends ParentSettingActivity implements View.OnClickListener, View.OnTouchListener, AdapterView.OnItemClickListener, AccessPoint.AccessPointListener, WifiDialog.WifiDialogListener, WifiTracker.WifiListener {
    ...
    public void onActivityCreated(Bundle bundle) {
        ...
        this.mConnectListener = new WifiManager.ActionListener() { // from class: jp.co.benesse.dcha.systemsettings.NetworkSettingActivity.1
        ...
        this.mSaveListener = new WifiManager.ActionListener() { // from class: jp.co.benesse.dcha.systemsettings.NetworkSettingActivity.2
            public void onSuccess() {
        ...
        this.mForgetListener = new WifiManager.ActionListener() { // from class: jp.co.benesse.dcha.systemsettings.NetworkSettingActivity.3
            public void onSuccess() {
