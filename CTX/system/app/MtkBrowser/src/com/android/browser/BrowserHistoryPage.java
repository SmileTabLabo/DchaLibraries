...
public class BrowserHistoryPage extends Fragment implements LoaderManager.LoaderCallbacks<Cursor>, ExpandableListView.OnChildClickListener {
    ...
    private AdapterView.OnItemClickListener mGroupItemClickListener = new AdapterView.OnItemClickListener() { // from class: com.android.browser.BrowserHistoryPage.1
    ...
    private AdapterView.OnItemClickListener mChildItemClickListener = new AdapterView.OnItemClickListener() { // from class: com.android.browser.BrowserHistoryPage.2
        @Override // android.widget.AdapterView.OnItemClickListener
        public void onItemClick(AdapterView<?> adapterView, View view, int i, long j) {
        ...
        public View getGroupView(int i, boolean z, View view, ViewGroup viewGroup) {
            ...
            if (i >= super.getGroupCount()) {
                ...
                if (view == null || !(view instanceof TextView)) {
                    textView = (TextView) LayoutInflater.from(getContext()).inflate(R.layout.history_header, (ViewGroup) null);
                } else {
