...
public class PageDialogsHandler {
    ...
    private AlertDialog.Builder createSslCertificateDialog(SslCertificate sslCertificate, SslError sslError) {
        ...
        if (sslError == null) {
            ...
            ((TextView) ((LinearLayout) from.inflate(R.layout.ssl_success, linearLayout)).findViewById(R.id.success)).setText(17040906);
        } else {
        ...
        return new AlertDialog.Builder(this.mContext).setTitle(17040905).setIcon(i).setView(inflateCertificateView);
    }
