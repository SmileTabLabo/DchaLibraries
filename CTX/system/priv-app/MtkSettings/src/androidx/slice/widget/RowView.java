...
public class RowView extends SliceChildView implements View.OnClickListener {
    ...
    private void addRange(final SliceItem range) {
        ...
        if (isSeekBar) {
            ...
            seekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() { // from class: androidx.slice.widget.RowView.1
    ...
    private void addAction(SliceActionImpl actionContent, int color, ViewGroup container, boolean isStart) {
        ...
        int actionType = !isToggle;
        int rowType = isToggle != 0 ? 3 : 0;
        EventInfo info = new EventInfo(getMode(), actionType, rowType, this.mRowIndex);
        if (isStart) {
    ...
    private void showSeeMore() {
        ...
        b.setOnClickListener(new View.OnClickListener() { // from class: androidx.slice.widget.RowView.2
