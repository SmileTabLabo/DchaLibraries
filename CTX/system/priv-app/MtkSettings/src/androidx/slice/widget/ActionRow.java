...
public class ActionRow extends FrameLayout {
            ...
            if (it.hasNext()) {
                ...
                if (input != null && image != null) {
                    if (Build.VERSION.SDK_INT >= 21) {
                        ...
                        Log.w("ActionRow", "Received RemoteInput on API <20 " + input);
                    }
                } else if (action.getIcon() != null && (iconItem = action.getIcon()) != null && actionItem != null) {
                    boolean tint = action.getImageMode() == 0;
                    addAction(iconItem, tint).setOnClickListener(new View.OnClickListener() { // from class: androidx.slice.widget.ActionRow.1
    ...
    private void handleSetRemoteInputActions(final SliceItem input, SliceItem image, final SliceItem action) {
        if (input.getRemoteInput().getAllowFreeFormInput()) {
            ...
            addAction(image.getIcon(), tint).setOnClickListener(new View.OnClickListener() { // from class: androidx.slice.widget.ActionRow.2
                @Override // android.view.View.OnClickListener
                public void onClick(View v) {
