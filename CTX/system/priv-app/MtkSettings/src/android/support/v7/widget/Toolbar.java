...
public class Toolbar extends ViewGroup {
    ...
    public Toolbar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        int contentInsetStart = a.getDimensionPixelOffset(R.styleable.Toolbar_contentInsetStart, AccessPoint.UNREACHABLE_RSSI);
        int contentInsetEnd = a.getDimensionPixelOffset(R.styleable.Toolbar_contentInsetEnd, AccessPoint.UNREACHABLE_RSSI);
        ...
        this.mContentInsetStartWithNavigation = a.getDimensionPixelOffset(R.styleable.Toolbar_contentInsetStartWithNavigation, AccessPoint.UNREACHABLE_RSSI);
        this.mContentInsetEndWithActions = a.getDimensionPixelOffset(R.styleable.Toolbar_contentInsetEndWithActions, AccessPoint.UNREACHABLE_RSSI);
    ...
    private void ensureMenuView() {
        if (this.mMenuView == null) {
            ...
            lp.gravity = 8388613 | (this.mButtonGravity & R.styleable.AppCompatTheme_windowActionBarOverlay);
    ...
    public void setContentInsetStartWithNavigation(int insetStartWithNavigation) {
        if (insetStartWithNavigation < 0) {
            insetStartWithNavigation = AccessPoint.UNREACHABLE_RSSI;
        }
    ...
    public void setContentInsetEndWithActions(int insetEndWithActions) {
        if (insetEndWithActions < 0) {
            insetEndWithActions = AccessPoint.UNREACHABLE_RSSI;
        }
    ...
    private void ensureNavButtonView() {
        if (this.mNavButtonView == null) {
            ...
            LayoutParams lp = generateDefaultLayoutParams();
            lp.gravity = 8388611 | (this.mButtonGravity & R.styleable.AppCompatTheme_windowActionBarOverlay);
    ...
    */
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        int right = width3 - paddingRight2;
        int[] collapsingMargins = this.mTempMargins;
        ...
        collapsingMargins[1] = Math.max(0, contentInsetRight - ((width3 - paddingRight2) - right));
        int left3 = Math.max(left2, contentInsetLeft);
        int right2 = Math.min(right, (width3 - paddingRight2) - contentInsetRight);
        if (shouldLayout(this.mExpandedActionView)) {
            if (isRtl) {
        ...
        if (layoutTitle || layoutSubtitle) {
            ...
            if (!layoutSubtitle || this.mSubtitleTextView.getMeasuredWidth() <= 0) {
                titleHasWidth = false;
                width = width3;
                width2 = this.mGravity & R.styleable.AppCompatTheme_windowActionBarOverlay;
                ...
                if (!isRtl) {
                    ...
                    if (layoutSubtitle) {
                        ...
                        this.mSubtitleTextView.layout(subtitleLeft, titleTop3, subtitleRight2, subtitleBottom2);
                        subtitleLeft = subtitleRight2 + this.mTitleMarginEnd;
                        int titleTop4 = subtitleBottom2 + lp4.bottomMargin;
                    }
                    if (titleHasWidth) {
                        left3 = Math.max(titleLeft2, subtitleLeft);
                    }
                }
            }
            titleHasWidth = true;
        ...
        for (int i2 = 0; i2 < i; i2++) {
            left3 = layoutChildLeft(this.mTempViews.get(i2), left3, collapsingMargins, alignmentHeight);
        }
        int alignmentHeight3 = alignmentHeight;
        addCustomViewsWithGravity(this.mTempViews, 5);
        int rightViewsCount = this.mTempViews.size();
        for (int i3 = 0; i3 < rightViewsCount; i3++) {
            right2 = layoutChildRight(this.mTempViews.get(i3), right2, collapsingMargins, alignmentHeight3);
        }
        ...
        while (true) {
            int i5 = i4;
            int leftViewsCount = i;
            if (i5 < centerViewsCount) {
                centerLeft = layoutChildLeft(this.mTempViews.get(i5), centerLeft, collapsingMargins, alignmentHeight3);
                i4 = i5 + 1;
                i = leftViewsCount;
    ...
    private int getChildVerticalGravity(int gravity) {
        int vgrav = gravity & R.styleable.AppCompatTheme_windowActionBarOverlay;
        if (vgrav == 16 || vgrav == 48 || vgrav == 80) {
            return vgrav;
        }
        return this.mGravity & R.styleable.AppCompatTheme_windowActionBarOverlay;
    }
    ...
    public class ExpandedActionViewMenuPresenter implements MenuPresenter {
        ...
        public boolean expandItemActionView(MenuBuilder menu, MenuItemImpl item) {
            ...
            if (expandedActionParent != Toolbar.this) {
                ...
                lp.gravity = 8388611 | (Toolbar.this.mButtonGravity & R.styleable.AppCompatTheme_windowActionBarOverlay);
                lp.mViewType = 2;
