...
public class StaggeredGridLayoutManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    int mPendingScrollPositionOffset = AccessPoint.UNREACHABLE_RSSI;
    ...
    public void onLayoutCompleted(RecyclerView.State state) {
        ...
        this.mPendingScrollPositionOffset = AccessPoint.UNREACHABLE_RSSI;
    ...
    private boolean updateAnchorFromChildren(RecyclerView.State state, AnchorInfo anchorInfo) {
        ...
        anchorInfo.mOffset = AccessPoint.UNREACHABLE_RSSI;
        return true;
    }
    ...
    public Parcelable onSaveInstanceState() {
        ...
        if (getChildCount() > 0) {
            ...
            while (true) {
                ...
                if (this.mLastLayoutFromEnd) {
                    line = this.mSpans[i].getEndLine(AccessPoint.UNREACHABLE_RSSI);
                    if (line != Integer.MIN_VALUE) {
                        line -= this.mPrimaryOrientation.getEndAfterPadding();
                    }
                } else {
                    line = this.mSpans[i].getStartLine(AccessPoint.UNREACHABLE_RSSI);
                    if (line != Integer.MIN_VALUE) {
                        line -= this.mPrimaryOrientation.getStartAfterPadding();
                    }
                }
    ...
    private void fixEndGap(RecyclerView.Recycler recycler, RecyclerView.State state, boolean canOffsetChildren) {
        int gap;
        int maxEndLine = getMaxEnd(AccessPoint.UNREACHABLE_RSSI);
    ...
    private int fill(RecyclerView.Recycler recycler, LayoutState layoutState, RecyclerView.State state) {
        ...
        if (this.mLayoutState.mInfinite) {
            if (layoutState.mLayoutDirection == 1) {
                ...
                targetLine = AccessPoint.UNREACHABLE_RSSI;
            }
    ...
    boolean areAllEndsEqual() {
        int end = this.mSpans[0].getEndLine(AccessPoint.UNREACHABLE_RSSI);
        for (int i = 1; i < this.mSpanCount; i++) {
            if (this.mSpans[i].getEndLine(AccessPoint.UNREACHABLE_RSSI) != end) {
                return false;
            }
        }
        return true;
    ...
    boolean areAllStartsEqual() {
        int start = this.mSpans[0].getStartLine(AccessPoint.UNREACHABLE_RSSI);
        for (int i = 1; i < this.mSpanCount; i++) {
            if (this.mSpans[i].getStartLine(AccessPoint.UNREACHABLE_RSSI) != start) {
                return false;
            }
        }
        return true;
    ...
    private Span getNextSpan(LayoutState layoutState) {
        ...
        int maxLine = AccessPoint.UNREACHABLE_RSSI;
    ...
    public class Span {
        ...
        int mCachedStart = AccessPoint.UNREACHABLE_RSSI;
        int mCachedEnd = AccessPoint.UNREACHABLE_RSSI;
        int mDeletedSize = 0;
        ...
        void prependToSpan(View view) {
            ...
            this.mCachedStart = AccessPoint.UNREACHABLE_RSSI;
            if (this.mViews.size() == 1) {
                this.mCachedEnd = AccessPoint.UNREACHABLE_RSSI;
            }
        ...
        void cacheReferenceLineAndClear(boolean reverseLayout, int offset) {
            int reference;
            if (reverseLayout) {
                reference = getEndLine(AccessPoint.UNREACHABLE_RSSI);
            } else {
                reference = getStartLine(AccessPoint.UNREACHABLE_RSSI);
            }
            clear();
    ...
    public class AnchorInfo {
        ...
        void reset() {
            this.mPosition = -1;
            this.mOffset = AccessPoint.UNREACHABLE_RSSI;
        ...
        void saveSpanReferenceLines(Span[] spans) {
            ...
            for (int i = 0; i < spanCount; i++) {
                this.mSpanReferenceLines[i] = spans[i].getStartLine(AccessPoint.UNREACHABLE_RSSI);
            }
        }
