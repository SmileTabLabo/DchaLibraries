    ...
    */
    ...
    public class ViewFlinger implements Runnable {
        ...
        public void fling(int velocityX, int velocityY) {
            ...
            this.mLastFlingY = 0;
            this.mLastFlingX = 0;
            this.mScroller.fling(0, 0, velocityX, velocityY, AccessPoint.UNREACHABLE_RSSI, Preference.DEFAULT_ORDER, AccessPoint.UNREACHABLE_RSSI, Preference.DEFAULT_ORDER);
            postOnAnimation();
        }
    ...
    public static abstract class LayoutManager {
        ...
        void setMeasuredDimensionFromChildren(int widthSpec, int heightSpec) {
            ...
            int maxX = AccessPoint.UNREACHABLE_RSSI;
            int maxY = AccessPoint.UNREACHABLE_RSSI;
            for (int i = 0; i < count; i++) {
                View child = getChildAt(i);
        ...
        */
        public static int getChildMeasureSpec(int parentSize, int parentMode, int padding, int childDimension, boolean canScroll) {
            ...
            if (canScroll) {
                ...
                resultSize = size;
                resultMode = (parentMode == Integer.MIN_VALUE || parentMode == 1073741824) ? AccessPoint.UNREACHABLE_RSSI : 0;
            }
    ...
    public static abstract class SmoothScroller {
        ...
        public static class Action {
            ...
            public Action(int dx, int dy) {
                this(dx, dy, AccessPoint.UNREACHABLE_RSSI, null);
            }
