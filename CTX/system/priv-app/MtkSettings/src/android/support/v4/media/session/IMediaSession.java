            ...
            if (code == 51) {
                ...
                switch (code) {
                    ...
                    case 28:
                        ...
                        return true;
                    case R.styleable.Preference_order /* 29 */:
                        data.enforceInterface("android.support.v4.media.session.IMediaSession");
                    ...
                    case 31:
                        ...
                        return true;
                    case R.styleable.Preference_selectable /* 32 */:
                        data.enforceInterface("android.support.v4.media.session.IMediaSession");
                        int _result11 = getRatingType();
                        reply.writeNoException();
                        reply.writeInt(_result11);
                        return true;
                    case R.styleable.Preference_shouldDisableView /* 33 */:
                        data.enforceInterface("android.support.v4.media.session.IMediaSession");
                        prepare();
                        reply.writeNoException();
                        return true;
                    case R.styleable.Preference_singleLineTitle /* 34 */:
                        data.enforceInterface("android.support.v4.media.session.IMediaSession");
                        ...
                        reply.writeNoException();
                        return true;
                    case R.styleable.Preference_summary /* 35 */:
                        data.enforceInterface("android.support.v4.media.session.IMediaSession");
                        ...
                        reply.writeNoException();
                        return true;
                    case R.styleable.Preference_title /* 36 */:
                        data.enforceInterface("android.support.v4.media.session.IMediaSession");
                        if (data.readInt() != 0) {
                        ...
                        reply.writeNoException();
                        return true;
                    case R.styleable.Preference_widgetLayout /* 37 */:
                        data.enforceInterface("android.support.v4.media.session.IMediaSession");
