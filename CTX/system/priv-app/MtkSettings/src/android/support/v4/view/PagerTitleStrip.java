...
public class PagerTitleStrip extends ViewGroup {
    ...
    void updateText(int currentItem, PagerAdapter adapter) {
        ...
        int childWidthSpec = View.MeasureSpec.makeMeasureSpec(maxWidth, AccessPoint.UNREACHABLE_RSSI);
        int childHeight = (getHeight() - getPaddingTop()) - getPaddingBottom();
        int maxHeight = Math.max(0, childHeight);
        int childHeightSpec = View.MeasureSpec.makeMeasureSpec(maxHeight, AccessPoint.UNREACHABLE_RSSI);
    ...
    public void updateTextPositions(int position, float positionOffset, boolean force) {
        ...
        int vgrav2 = alignedPrevHeight2 & R.styleable.AppCompatTheme_windowActionBarOverlay;
        if (vgrav2 == 16) {
