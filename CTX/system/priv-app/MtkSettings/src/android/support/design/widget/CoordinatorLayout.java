...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent2 {
    ...
    */
    ...
    private void getDesiredAnchoredChildRectWithoutConstraints(View child, int layoutDirection, Rect anchorRect, Rect out, LayoutParams lp, int childWidth, int childHeight) {
        ...
        int vgrav = absGravity & android.support.v7.appcompat.R.styleable.AppCompatTheme_windowActionBarOverlay;
        int anchorHgrav = absAnchorGravity & 7;
        int anchorVgrav = absAnchorGravity & android.support.v7.appcompat.R.styleable.AppCompatTheme_windowActionBarOverlay;
        if (anchorHgrav != 1) {
            if (anchorHgrav != 5) {
    ...
    private static int resolveGravity(int gravity) {
        ...
        if ((gravity & android.support.v7.appcompat.R.styleable.AppCompatTheme_windowActionBarOverlay) == 0) {
            return gravity | 48;
        }
        return gravity;
    }
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (type != 0 || child.getVisibility() != 8) {
                ...
                if (lp.insetEdge != 0 && !drawRect.isEmpty()) {
                    ...
                    int i2 = absInsetEdge & android.support.v7.appcompat.R.styleable.AppCompatTheme_windowActionBarOverlay;
                    if (i2 == 48) {
