...
public class InputMethodAndSubtypeEnablerManager implements Preference.OnPreferenceChangeListener {
    ...
    public static /* synthetic */ int lambda$addInputMethodSubtypePreferences$0(InputMethodAndSubtypeEnablerManager inputMethodAndSubtypeEnablerManager, Preference preference, Preference preference2) {
        if (preference instanceof InputMethodSubtypePreference) {
