...
public class TimeoutListPreference extends RestrictedListPreference {
    ...
    public void onDialogCreated(Dialog dialog) {
        ...
        dialog.create();
        if (this.mAdmin != null) {
            dialog.findViewById(R.id.admin_disabled_other_options).findViewById(R.id.admin_more_details_link).setOnClickListener(new View.OnClickListener() { // from class: com.android.settings.TimeoutListPreference.1
