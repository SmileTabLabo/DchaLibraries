...
public class SettingsAppWidgetProvider extends AppWidgetProvider {
    ...
    private static final class WifiStateTracker extends StateTracker {
        ...
        /* JADX WARN: Type inference failed for: r1v0, types: [com.android.settings.widget.SettingsAppWidgetProvider$WifiStateTracker$1] */
        @Override // com.android.settings.widget.SettingsAppWidgetProvider.StateTracker
    ...
    private static final class BluetoothStateTracker extends StateTracker {
        ...
        /* JADX WARN: Type inference failed for: r1v2, types: [com.android.settings.widget.SettingsAppWidgetProvider$BluetoothStateTracker$1] */
        @Override // com.android.settings.widget.SettingsAppWidgetProvider.StateTracker
    ...
    public static final class LocationStateTracker extends StateTracker {
        ...
        /* JADX WARN: Type inference failed for: r2v1, types: [com.android.settings.widget.SettingsAppWidgetProvider$LocationStateTracker$1] */
        @Override // com.android.settings.widget.SettingsAppWidgetProvider.StateTracker
