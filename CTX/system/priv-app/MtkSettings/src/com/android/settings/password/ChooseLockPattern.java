    ...
    public static class ChooseLockPatternFragment extends InstrumentedFragment implements View.OnClickListener, SaveChosenLockWorkerBase.Listener {
        ...
        protected LockPatternView.OnPatternListener mChooseNewLockPatternListener = new LockPatternView.OnPatternListener() { // from class: com.android.settings.password.ChooseLockPattern.ChooseLockPatternFragment.1
            ...
            private void patternInProgress() {
                ...
                if (ChooseLockPatternFragment.this.mTitleHeaderScrollView != null) {
                    ChooseLockPatternFragment.this.mTitleHeaderScrollView.post(new Runnable() { // from class: com.android.settings.password.ChooseLockPattern.ChooseLockPatternFragment.1.1
        ...
        public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
            ...
            if (getResources().getBoolean(R.bool.config_lock_pattern_minimal_ui)) {
                View findViewById = glifLayout.findViewById(R.id.suw_layout_icon);
