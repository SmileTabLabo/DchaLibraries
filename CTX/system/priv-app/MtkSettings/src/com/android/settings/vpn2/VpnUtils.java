...
public class VpnUtils {
    ...
    public static boolean isAnyLockdownActive(Context context) {
        ...
        return (getConnectivityManager(context).getAlwaysOnVpnPackageForUser(userId) == null || Settings.Secure.getIntForUser(context.getContentResolver(), "always_on_vpn_lockdown", 0, userId) == 0) ? false : true;
    }
