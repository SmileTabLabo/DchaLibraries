...
public class PhoneStatusBarPolicy implements CommandQueue.Callbacks, BluetoothController.Callback, DataSaverController.Listener, DeviceProvisionedController.DeviceProvisionedListener, KeyguardMonitor.Callback, LocationController.LocationChangeCallback, RotationLockController.RotationLockControllerCallback, ZenModeController.Callback {
    ...
    public PhoneStatusBarPolicy(Context context, StatusBarIconController statusBarIconController) {
        ...
        this.mSlotCast = context.getString(17040911);
        this.mSlotHotspot = context.getString(17040918);
        this.mSlotBluetooth = context.getString(17040910);
        this.mSlotTty = context.getString(17040932);
        this.mSlotZen = context.getString(17040936);
        this.mSlotVolume = context.getString(17040933);
        this.mSlotAlarmClock = context.getString(17040908);
        this.mSlotManagedProfile = context.getString(17040921);
        this.mSlotRotate = context.getString(17040927);
        this.mSlotHeadset = context.getString(17040917);
        this.mSlotDataSaver = context.getString(17040915);
        this.mSlotLocation = context.getString(17040920);
