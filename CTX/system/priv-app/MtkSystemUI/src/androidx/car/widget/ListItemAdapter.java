...
public class ListItemAdapter extends RecyclerView.Adapter<ListItem.ViewHolder> implements PagedListView.DividerVisibilityManager, PagedListView.ItemCap {
    ...
    public ListItemAdapter(Context context, ListItemProvider itemProvider, int backgroundStyle) {
        ...
        registerListItemViewType(1, R.layout.car_list_item_text_content, new Function() { // from class: androidx.car.widget.-$$Lambda$G05oNAIwQGFB9mxWoy7r_749aLM
            @Override // java.util.function.Function
            public final Object apply(Object obj) {
                return TextListItem.createViewHolder((View) obj);
            }
        });
        registerListItemViewType(2, R.layout.car_list_item_seekbar_content, new Function() { // from class: androidx.car.widget.-$$Lambda$S-EZJp6rVWMiTQ299o0KnvcXb2Q
            @Override // java.util.function.Function
            public final Object apply(Object obj) {
                return SeekbarListItem.createViewHolder((View) obj);
            }
        });
        registerListItemViewType(3, R.layout.car_list_item_subheader_content, new Function() { // from class: androidx.car.widget.-$$Lambda$GlrioeKNPv_Q0xdH_pxbPyg4xjE
            @Override // java.util.function.Function
            public final Object apply(Object obj) {
                return SubheaderListItem.createViewHolder((View) obj);
            }
        });
        this.mUxRestrictionsHelper = new CarUxRestrictionsHelper(context, new CarUxRestrictionsManager.OnUxRestrictionsChangedListener() { // from class: androidx.car.widget.-$$Lambda$ListItemAdapter$mRFG7p_Xdn8NKaeSLZRLvbjySsc
            public final void onUxRestrictionsChanged(CarUxRestrictions carUxRestrictions) {
                ListItemAdapter.lambda$new$8(ListItemAdapter.this, carUxRestrictions);
            }
        });
    }

    public static /* synthetic */ void lambda$new$8(ListItemAdapter listItemAdapter, CarUxRestrictions carUxRestrictions) {
