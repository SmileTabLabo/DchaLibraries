...
public abstract class LiveData<T> {
    ...
    public void observeForever(Observer<? super T> observer) {
        ...
        LiveData<T>.ObserverWrapper alwaysActiveObserver = new AlwaysActiveObserver(observer);
        LiveData<T>.ObserverWrapper existing = this.mObservers.putIfAbsent(observer, alwaysActiveObserver);
