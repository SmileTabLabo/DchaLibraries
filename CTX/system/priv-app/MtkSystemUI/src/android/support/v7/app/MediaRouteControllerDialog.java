...
public class MediaRouteControllerDialog extends AlertDialog {
    ...
    */
    ...
    void updateLayoutHeight(final boolean animate) {
        ...
        observer.addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() { // from class: android.support.v7.app.MediaRouteControllerDialog.6
    ...
    private void animateLayoutHeight(final View view, final int targetHeight) {
        ...
        Animation anim = new Animation() { // from class: android.support.v7.app.MediaRouteControllerDialog.7
    ...
    private void animateGroupListItems(final Map<MediaRouter.RouteInfo, Rect> previousRouteBoundMap, final Map<MediaRouter.RouteInfo, BitmapDrawable> previousRouteBitmapMap) {
        ...
        observer.addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() { // from class: android.support.v7.app.MediaRouteControllerDialog.8
            @Override // android.view.ViewTreeObserver.OnGlobalLayoutListener
            public void onGlobalLayout() {
    ...
    void animateGroupListItemsInternal(Map<MediaRouter.RouteInfo, Rect> previousRouteBoundMap, Map<MediaRouter.RouteInfo, BitmapDrawable> previousRouteBitmapMap) {
        ...
        Animation.AnimationListener listener2 = new Animation.AnimationListener() { // from class: android.support.v7.app.MediaRouteControllerDialog.9
        ...
        for (Map.Entry<MediaRouter.RouteInfo, BitmapDrawable> item : previousRouteBitmapMap.entrySet()) {
            ...
            if (this.mGroupMemberRoutesRemoved.contains(route2)) {
                ...
                OverlayListView.OverlayObject object2 = new OverlayListView.OverlayObject(bitmap, bounds).setTranslateYAnimation(deltaY).setDuration(this.mGroupListAnimationDurationMs).setInterpolator(this.mInterpolator).setAnimationEndListener(new OverlayListView.OverlayObject.OnAnimationEndListener() { // from class: android.support.v7.app.MediaRouteControllerDialog.10
    ...
    void startGroupListFadeInAnimation() {
        ...
        this.mVolumeGroupList.requestLayout();
        ViewTreeObserver observer = this.mVolumeGroupList.getViewTreeObserver();
        observer.addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() { // from class: android.support.v7.app.MediaRouteControllerDialog.11
            @Override // android.view.ViewTreeObserver.OnGlobalLayoutListener
            public void onGlobalLayout() {
                MediaRouteControllerDialog.this.mVolumeGroupList.getViewTreeObserver().removeGlobalOnLayoutListener(this);
    ...
    private void fadeInAddedRoutes() {
        Animation.AnimationListener listener = new Animation.AnimationListener() { // from class: android.support.v7.app.MediaRouteControllerDialog.12
            @Override // android.view.animation.Animation.AnimationListener
            public void onAnimationStart(Animation animation) {
            }
    ...
    public class FetchArtTask extends AsyncTask<Void, Void, Bitmap> {
        ...
        /* JADX WARN: Type inference failed for: r4v0, types: [android.graphics.Rect, android.graphics.Bitmap, java.io.InputStream] */
        @Override // android.os.AsyncTask
        public Bitmap doInBackground(Void... arg) {
            InputStream stream;
            Bitmap art = null;
            InputStream stream2 = 0;
                ...
                try {
                    try {
                        try {
                            ...
                            stream2 = openInputStreamByScheme;
                            ...
                            BitmapFactory.decodeStream(stream2, stream2, options);
                            ...
                            art = BitmapFactory.decodeStream(stream, stream2, options);
                            if (stream != null) {
                                stream.close();
                            }
            ...
            if (art != null && art.getWidth() < art.getHeight()) {
                ...
                this.mBackgroundColor = palette.getSwatches().isEmpty() ? 0 : palette.getSwatches().get(0).getRgb();
            }
            return art;
        }
