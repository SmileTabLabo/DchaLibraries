...
public final class MediaRouter {
    ...
    public static final class GlobalMediaRouter implements RegisteredMediaRouteProviderWatcher.Callback, SystemMediaRouteProvider.SyncCallback {
        ...
        /* JADX WARN: Removed duplicated region for block: B:69:0x01a9 A[LOOP:3: B:68:0x01a7->B:69:0x01a9, LOOP_END] */
            ...
            if (provider.updateDescriptor(providerDescriptor)) {
                ...
                if (providerDescriptor != null) {
                    if (providerDescriptor.isValid()) {
                        ...
                        for (i2 = provider.mRoutes.size() - 1; i2 >= targetIndex; i2--) {
            ...
            public void configureVolume(int controlType, int max, int current) {
                ...
                this.mVpCompat = new VolumeProviderCompat(controlType, max, current) { // from class: android.support.v7.media.MediaRouter.GlobalMediaRouter.MediaSessionRecord.1
                    ...
                    public void onSetVolumeTo(final int volume) {
                        MediaSessionRecord.this.this$0.mCallbackHandler.post(new Runnable() { // from class: android.support.v7.media.MediaRouter.GlobalMediaRouter.MediaSessionRecord.1.1
                    ...
                    public void onAdjustVolume(final int direction) {
                        MediaSessionRecord.this.this$0.mCallbackHandler.post(new Runnable() { // from class: android.support.v7.media.MediaRouter.GlobalMediaRouter.MediaSessionRecord.1.2
                            @Override // java.lang.Runnable
                            public void run() {
                                if (MediaSessionRecord.this.this$0.mSelectedRoute != null) {
