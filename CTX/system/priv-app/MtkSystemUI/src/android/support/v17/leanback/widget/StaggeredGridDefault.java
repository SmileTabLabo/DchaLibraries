    ...
    protected boolean appendVisibleItemsWithoutCache(int toLimit, boolean oneColumnMode) {
        ...
        if (this.mLastVisibleIndex >= 0) {
            ...
            if (edgeLimitSearchIndex2 < 0) {
                ...
                edgeLimit2 = this.mReversedFlow ? findRowMin(false, edgeLimitSearchIndex2, null) : findRowMax(true, edgeLimitSearchIndex2, null);
            }
    ...
    protected boolean prependVisibleItemsWithoutCache(int toLimit, boolean oneColumnMode) {
        ...
        if (this.mFirstVisibleIndex >= 0) {
            ...
            if (edgeLimitSearchIndex2 < 0) {
                ...
                edgeLimit = this.mReversedFlow ? findRowMax(true, edgeLimitSearchIndex2, null) : findRowMin(false, edgeLimitSearchIndex2, null);
            }
