    ...
    */
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        if (this.mConsumedInsets.right > 0) {
            int width = getWidth();
            canvas.drawRect(width - this.mConsumedInsets.right, 0.0f, width, getHeight(), this.mOpaquePaint);
        }
        ...
        if (this.mConsumedInsets.bottom > 0) {
            ...
            canvas.drawRect(0.0f, height - this.mConsumedInsets.bottom, getWidth(), height, this.mOpaquePaint);
        }
    }
