...
public final class MediaMetadata2 {
    ...
    public Rating2 getRating(@NonNull String key) {
        ...
        try {
            Rating2 rating = Rating2.fromBundle(this.mBundle.getBundle(key));
            return rating;
        } catch (Exception e) {
    ...
    public static final class Builder {
        ...
        public Builder putText(@NonNull String key, @Nullable CharSequence value) {
            ...
            if (MediaMetadata2.METADATA_KEYS_TYPE.containsKey(key) && MediaMetadata2.METADATA_KEYS_TYPE.get(key).intValue() != 1) {
        ...
        public Builder putLong(@NonNull String key, long value) {
            ...
            if (MediaMetadata2.METADATA_KEYS_TYPE.containsKey(key) && MediaMetadata2.METADATA_KEYS_TYPE.get(key).intValue() != 0) {
        ...
        public Builder putRating(@NonNull String key, @Nullable Rating2 value) {
            ...
            if (MediaMetadata2.METADATA_KEYS_TYPE.containsKey(key) && MediaMetadata2.METADATA_KEYS_TYPE.get(key).intValue() != 3) {
        ...
        public Builder putBitmap(@NonNull String key, @Nullable Bitmap value) {
            ...
            if (MediaMetadata2.METADATA_KEYS_TYPE.containsKey(key) && MediaMetadata2.METADATA_KEYS_TYPE.get(key).intValue() != 2) {
        ...
        public Builder putFloat(@NonNull String key, float value) {
            ...
            if (MediaMetadata2.METADATA_KEYS_TYPE.containsKey(key) && MediaMetadata2.METADATA_KEYS_TYPE.get(key).intValue() != 4) {
