...
public class Cea708CaptionRenderer extends SubtitleController.Renderer {
    ...
    public boolean supports(MediaFormat format) {
        if (format.containsKey("mime")) {
            ...
            return SubtitleData2.MIMETYPE_TEXT_CEA_708.equals(mimeType);
        }
        return false;
    }
    ...
    public SubtitleTrack createTrack(MediaFormat format) {
        String mimeType = format.getString("mime");
        if (SubtitleData2.MIMETYPE_TEXT_CEA_708.equals(mimeType)) {
    ...
    public class Cea708CCWidget extends ClosedCaptionWidget implements Cea708CCParser.DisplayListener {
        ...
        public class CCWindowLayout extends RelativeLayout implements View.OnLayoutChangeListener {
            ...
            public void initWindow(CCLayout ccLayout, Cea708CCParser.CaptionWindow captionWindow) {
                ...
                float f = captionWindow.anchorVertical;
                boolean z = captionWindow.relativePositioning;
                int i = ANCHOR_RELATIVE_POSITIONING_MAX;
                float scaleRow = f / (z ? ANCHOR_RELATIVE_POSITIONING_MAX : ANCHOR_VERTICAL_MAX);
                float f2 = captionWindow.anchorHorizontal;
            ...
            private void updateTextSize() {
                ...
                while (startFontSize < endFontSize) {
                    ...
                    if (this.mCCLayout.getWidth() * 0.8f > width) {
                        float startFontSize2 = 0.01f + testTextSize;
                        startFontSize = startFontSize2;
                    } else {
                        float endFontSize2 = testTextSize - 0.01f;
                        endFontSize = endFontSize2;
                    }
                }
