...
public class MediaController2ImplLegacy implements MediaController2.SupportLibraryImpl {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public MediaController2ImplLegacy(@NonNull Context context, @NonNull MediaController2 instance, @NonNull SessionToken2 token, @NonNull Executor executor, @NonNull MediaController2.ControllerCallback callback) {
    ...
    public long getCurrentPosition() {
        synchronized (this.mLock) {
            if (!this.mConnected) {
                ...
                long expectedPosition = this.mPlaybackStateCompat.getPosition() + (this.mPlaybackStateCompat.getPlaybackSpeed() * ((float) timeDiff));
