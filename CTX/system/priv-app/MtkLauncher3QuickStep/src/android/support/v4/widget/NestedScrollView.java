...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent2, NestedScrollingChild2, ScrollingView {
    ...
    public boolean executeKeyEvent(@NonNull KeyEvent event) {
        ...
        if (!canScroll) {
            ...
            return (nextFocused == null || nextFocused == this || !nextFocused.requestFocus(Cea708CCParser.Const.CODE_C1_CW2)) ? false : true;
            ...
            if (keyCode != 62) {
                switch (keyCode) {
                    ...
                    case 20:
                        if (!event.isAltPressed()) {
                            boolean handled3 = arrowScroll(Cea708CCParser.Const.CODE_C1_CW2);
                            return handled3;
                        }
                        boolean handled4 = fullScroll(Cea708CCParser.Const.CODE_C1_CW2);
                        return handled4;
                    default:
                        return false;
                }
    ...
    public void computeScroll() {
        ...
        if (this.mScroller.computeScrollOffset()) {
            ...
            if (dy2 != 0) {
                ...
                int oldScrollY = getScrollY();
                overScrollByCompat(0, dy2, getScrollX(), oldScrollY, 0, range2, 0, 0, false);
                int scrolledDeltaY = getScrollY() - oldScrollY;
                int unconsumedY = dy2 - scrolledDeltaY;
