...
public class TaskViewHeader extends FrameLayout implements View.OnClickListener, View.OnLongClickListener {
    ...
    /* JADX WARN: Type inference failed for: r0v5, types: [com.android.systemui.recents.views.TaskViewHeader$1] */
    public void startFocusTimerIndicator(int i) {
        ...
        this.mFocusTimerCountDown = new CountDownTimer(i, 30L) { // from class: com.android.systemui.recents.views.TaskViewHeader.1
