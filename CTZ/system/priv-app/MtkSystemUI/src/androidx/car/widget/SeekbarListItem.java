...
public class SeekbarListItem extends ListItem<ViewHolder> {
    ...
    private void setItemLayoutHeight() {
        ...
        this.mBinders.add(new ListItem.ViewBinder() { // from class: androidx.car.widget.-$$Lambda$SeekbarListItem$7Tjjee35UV5Tm2kweKxgeql9p4I
    ...
    public static /* synthetic */ void lambda$setItemLayoutHeight$41(int i, ViewHolder vh) {
    ...
    private void setPrimaryActionLayout() {
        switch (this.mPrimaryActionType) {
            ...
            case 2:
                ...
                this.mBinders.add(new ListItem.ViewBinder() { // from class: androidx.car.widget.-$$Lambda$SeekbarListItem$M6J7eTnHpelBrTbuwhJIUrOJKxw
                    @Override // androidx.car.widget.ListItem.ViewBinder
                    public final void bind(Object obj) {
                        SeekbarListItem.lambda$setPrimaryActionLayout$42(SeekbarListItem.this, iconSize, startMargin, (SeekbarListItem.ViewHolder) obj);
                    }
                });
                return;
            default:
    ...
    public static /* synthetic */ void lambda$setPrimaryActionLayout$42(SeekbarListItem seekbarListItem, int i, int i2, ViewHolder vh) {
    ...
    private void setPrimaryActionContent() {
        switch (this.mPrimaryActionType) {
            ...
            case 1:
                return;
            case 2:
                this.mBinders.add(new ListItem.ViewBinder() { // from class: androidx.car.widget.-$$Lambda$SeekbarListItem$K1nOHRrGW93HPmduhJRS0oG8aXg
                    @Override // androidx.car.widget.ListItem.ViewBinder
                    public final void bind(Object obj) {
                        SeekbarListItem.lambda$setPrimaryActionContent$43(SeekbarListItem.this, (SeekbarListItem.ViewHolder) obj);
                    }
                });
                return;
            default:
    ...
    public static /* synthetic */ void lambda$setPrimaryActionContent$43(SeekbarListItem seekbarListItem, ViewHolder vh) {
    ...
    private void setSeekBarAndTextContent() {
        this.mBinders.add(new ListItem.ViewBinder() { // from class: androidx.car.widget.-$$Lambda$SeekbarListItem$lSn9m8ivb9fSapIqjcRgGsmpj3U
            @Override // androidx.car.widget.ListItem.ViewBinder
            public final void bind(Object obj) {
                SeekbarListItem.lambda$setSeekBarAndTextContent$44(SeekbarListItem.this, (SeekbarListItem.ViewHolder) obj);
            }
        });
    }

    public static /* synthetic */ void lambda$setSeekBarAndTextContent$44(SeekbarListItem seekbarListItem, ViewHolder vh) {
    ...
    private void setSeekBarAndTextLayout() {
        this.mBinders.add(new ListItem.ViewBinder() { // from class: androidx.car.widget.-$$Lambda$SeekbarListItem$TBLDTt7Paps7Sd3hQA-yyAdyr84
            @Override // androidx.car.widget.ListItem.ViewBinder
            public final void bind(Object obj) {
                SeekbarListItem.lambda$setSeekBarAndTextLayout$45(SeekbarListItem.this, (SeekbarListItem.ViewHolder) obj);
            }
        });
    }

    public static /* synthetic */ void lambda$setSeekBarAndTextLayout$45(SeekbarListItem seekbarListItem, ViewHolder vh) {
    ...
    private void setViewEndMargin(View v) {
        ...
        switch (this.mSupplementalActionType) {
            ...
            case 2:
                layoutParams.addRule(21);
                layoutParams.removeRule(16);
                layoutParams.setMarginEnd(endMargin + this.mContext.getResources().getDimensionPixelSize(R.dimen.car_padding_4) + this.mContext.getResources().getDimensionPixelSize(R.dimen.car_primary_icon_size) + this.mContext.getResources().getDimensionPixelSize(R.dimen.car_keyline_1));
                break;
            default:
    ...
    private void setSupplementalActionLayout() {
        ...
        this.mBinders.add(new ListItem.ViewBinder() { // from class: androidx.car.widget.-$$Lambda$SeekbarListItem$dHnhL41oWX8JGw1b-gp27swpZ_M
            @Override // androidx.car.widget.ListItem.ViewBinder
            public final void bind(Object obj) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static /* synthetic */ void lambda$setSupplementalActionLayout$46(int i, int i2, ViewHolder vh) {
    ...
    private void setSupplementalActionContent() {
        switch (this.mSupplementalActionType) {
            ...
            case 3:
                return;
            case 1:
                this.mBinders.add(new ListItem.ViewBinder() { // from class: androidx.car.widget.-$$Lambda$SeekbarListItem$Su6AbqkAIyFHS_MGB7hp8rpzrMI
                    @Override // androidx.car.widget.ListItem.ViewBinder
                    public final void bind(Object obj) {
                        SeekbarListItem.lambda$setSupplementalActionContent$47(SeekbarListItem.this, (SeekbarListItem.ViewHolder) obj);
                    }
                });
                return;
            default:
    ...
    public static /* synthetic */ void lambda$setSupplementalActionContent$47(SeekbarListItem seekbarListItem, ViewHolder vh) {
