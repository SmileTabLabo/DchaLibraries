...
public final class CodedOutputByteBufferNano {
    ...
    */
    ...
    public void writeBytesNoTag(byte[] bArr, int i, int i2) throws IOException {
        writeRawVarint32(i2);
    ...
    public static int computeBytesSize(int i, int i2) {
        return computeTagSize(i) + computeBytesSizeNoTag(i2);
    }
