...
public class TaskStackChangeListeners extends TaskStackListener {
    ...
    public void onTaskRemoved(int taskId) throws RemoteException {
        this.mHandler.obtainMessage(12, taskId, 0).sendToTarget();
    }
                ...
                switch (msg.what) {
                    ...
                    case 13:
                        for (int i14 = TaskStackChangeListeners.this.mTaskStackListeners.size() - 1; i14 >= 0; i14--) {
                            ((TaskStackChangeListener) TaskStackChangeListeners.this.mTaskStackListeners.get(i14)).onTaskMovedToFront(msg.arg1);
                        }
                        break;
                    case 14:
