...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent2 {
    ...
    */
    ...
    private void getDesiredAnchoredChildRectWithoutConstraints(View child, int layoutDirection, Rect anchorRect, Rect out, LayoutParams lp, int childWidth, int childHeight) {
        ...
        int vgrav = absGravity & AbstractFloatingView.TYPE_REBIND_SAFE;
        int anchorHgrav = absAnchorGravity & 7;
        int anchorVgrav = absAnchorGravity & AbstractFloatingView.TYPE_REBIND_SAFE;
        if (anchorHgrav != 1) {
            if (anchorHgrav != 5) {
    ...
    private static int resolveGravity(int gravity) {
        ...
        if ((gravity & AbstractFloatingView.TYPE_REBIND_SAFE) == 0) {
            return gravity | 48;
        }
        return gravity;
    }
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (type != 0 || child.getVisibility() != 8) {
                ...
                if (lp.insetEdge != 0 && !drawRect.isEmpty()) {
                    ...
                    int i2 = absInsetEdge & AbstractFloatingView.TYPE_REBIND_SAFE;
                    if (i2 == 48) {
