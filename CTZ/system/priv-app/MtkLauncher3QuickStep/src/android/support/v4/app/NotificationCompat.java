        ...
        public RemoteViews applyStandardTemplate(boolean showSmallIcon, int resId, boolean fitIn1U) {
            ...
            if (this.mBuilder.mSubText != null && Build.VERSION.SDK_INT >= 16) {
                ...
                if (this.mBuilder.mContentText != null) {
                    ...
                    contentView.setViewVisibility(R.id.line3, showLine32 ? 0 : i2);
                    return contentView;
                }
                i = 8;
    ...
    static Action getActionCompatFromAction(Notification.Action action) {
        ...
        if (srcArray == null) {
            ...
            for (int i2 = 0; i2 < srcArray.length; i2++) {
                ...
                remoteInputs[i2] = new RemoteInput(src.getResultKey(), src.getLabel(), src.getChoices(), src.getAllowFreeFormInput(), src.getExtras(), null);
            }
        }
