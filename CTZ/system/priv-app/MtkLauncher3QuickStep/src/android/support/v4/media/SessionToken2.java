...
public final class SessionToken2 {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP})
    public SessionToken2(SupportLibraryImpl impl) {
        this.mImpl = impl;
    }
        ...
        executor.execute(new Runnable() { // from class: android.support.v4.media.SessionToken2.1
            ...
            public void run() {
                try {
                    ...
                    MediaControllerCompat.Callback callback = new MediaControllerCompat.Callback() { // from class: android.support.v4.media.SessionToken2.1.1
