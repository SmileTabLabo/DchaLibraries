...
public class CategoryManager {
    ...
    public synchronized DashboardCategory getTilesByCategory(Context context, String str) {
        return getTilesByCategory(context, str, "com.android.settings");
    }
    ...
    public synchronized List<DashboardCategory> getCategories(Context context, String str) {
        tryInitCategories(context, str);
