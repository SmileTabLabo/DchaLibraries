...
public class ConditionAdapter extends RecyclerView.Adapter<DashboardAdapter.DashboardItemHolder> {
    ...
    private View.OnClickListener mConditionClickListener = new View.OnClickListener() { // from class: com.android.settings.dashboard.conditional.ConditionAdapter.1
    ...
    ItemTouchHelper.SimpleCallback mSwipeCallback = new ItemTouchHelper.SimpleCallback(0, 48) { // from class: com.android.settings.dashboard.conditional.ConditionAdapter.2
    ...
    private void bindViews(final Condition condition, DashboardAdapter.DashboardItemHolder dashboardItemHolder, boolean z, View.OnClickListener onClickListener) {
        ...
        while (i < 2) {
            ...
            if (actions.length > i) {
                ...
                button.setOnClickListener(new View.OnClickListener() { // from class: com.android.settings.dashboard.conditional.ConditionAdapter.3
                    @Override // android.view.View.OnClickListener
                    public void onClick(View view) {
