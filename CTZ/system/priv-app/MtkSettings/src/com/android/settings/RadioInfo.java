...
public class RadioInfo extends Activity {
    ...
    private final ConnectivityManager.NetworkCallback mNetworkCallback = new ConnectivityManager.NetworkCallback() { // from class: com.android.settings.RadioInfo.1
    ...
    private Handler mHandler = new Handler() { // from class: com.android.settings.RadioInfo.3
    ...
    private MenuItem.OnMenuItemClickListener mViewADNCallback = new MenuItem.OnMenuItemClickListener() { // from class: com.android.settings.RadioInfo.9
    ...
    private MenuItem.OnMenuItemClickListener mViewFDNCallback = new MenuItem.OnMenuItemClickListener() { // from class: com.android.settings.RadioInfo.10
        @Override // android.view.MenuItem.OnMenuItemClickListener
        public boolean onMenuItemClick(MenuItem menuItem) {
            Intent intent = new Intent("android.intent.action.VIEW");
    ...
    private MenuItem.OnMenuItemClickListener mViewSDNCallback = new MenuItem.OnMenuItemClickListener() { // from class: com.android.settings.RadioInfo.11
        @Override // android.view.MenuItem.OnMenuItemClickListener
        public boolean onMenuItemClick(MenuItem menuItem) {
    ...
    private MenuItem.OnMenuItemClickListener mGetImsStatus = new MenuItem.OnMenuItemClickListener() { // from class: com.android.settings.RadioInfo.12
        @Override // android.view.MenuItem.OnMenuItemClickListener
        public boolean onMenuItemClick(MenuItem menuItem) {
            String string;
    ...
    private MenuItem.OnMenuItemClickListener mSelectBandCallback = new MenuItem.OnMenuItemClickListener() { // from class: com.android.settings.RadioInfo.13
        @Override // android.view.MenuItem.OnMenuItemClickListener
        public boolean onMenuItemClick(MenuItem menuItem) {
    ...
    private MenuItem.OnMenuItemClickListener mToggleData = new MenuItem.OnMenuItemClickListener() { // from class: com.android.settings.RadioInfo.14
        @Override // android.view.MenuItem.OnMenuItemClickListener
        public boolean onMenuItemClick(MenuItem menuItem) {
    ...
    CompoundButton.OnCheckedChangeListener mRadioPowerOnChangeListener = new CompoundButton.OnCheckedChangeListener() { // from class: com.android.settings.RadioInfo.16
    ...
    CompoundButton.OnCheckedChangeListener mImsVolteCheckedChangeListener = new CompoundButton.OnCheckedChangeListener() { // from class: com.android.settings.RadioInfo.17
        @Override // android.widget.CompoundButton.OnCheckedChangeListener
        public void onCheckedChanged(CompoundButton compoundButton, boolean z) {
            RadioInfo.this.setImsVolteProvisionedState(z);
        }
    };
    CompoundButton.OnCheckedChangeListener mImsVtCheckedChangeListener = new CompoundButton.OnCheckedChangeListener() { // from class: com.android.settings.RadioInfo.18
        @Override // android.widget.CompoundButton.OnCheckedChangeListener
        public void onCheckedChanged(CompoundButton compoundButton, boolean z) {
            RadioInfo.this.setImsVtProvisionedState(z);
        }
    };
    CompoundButton.OnCheckedChangeListener mImsWfcCheckedChangeListener = new CompoundButton.OnCheckedChangeListener() { // from class: com.android.settings.RadioInfo.19
        @Override // android.widget.CompoundButton.OnCheckedChangeListener
        public void onCheckedChanged(CompoundButton compoundButton, boolean z) {
            RadioInfo.this.setImsWfcProvisionedState(z);
        }
    };
    CompoundButton.OnCheckedChangeListener mEabCheckedChangeListener = new CompoundButton.OnCheckedChangeListener() { // from class: com.android.settings.RadioInfo.20
        @Override // android.widget.CompoundButton.OnCheckedChangeListener
        public void onCheckedChanged(CompoundButton compoundButton, boolean z) {
            RadioInfo.this.setEabProvisionedState(z);
        }
    };
    View.OnClickListener mDnsCheckButtonHandler = new View.OnClickListener() { // from class: com.android.settings.RadioInfo.21
    ...
    View.OnClickListener mOemInfoButtonHandler = new View.OnClickListener() { // from class: com.android.settings.RadioInfo.22
        @Override // android.view.View.OnClickListener
        public void onClick(View view) {
            try {
    ...
    View.OnClickListener mPingButtonHandler = new View.OnClickListener() { // from class: com.android.settings.RadioInfo.23
        @Override // android.view.View.OnClickListener
        public void onClick(View view) {
            RadioInfo.this.updatePingState();
        }
    };
    View.OnClickListener mUpdateSmscButtonHandler = new View.OnClickListener() { // from class: com.android.settings.RadioInfo.24
        @Override // android.view.View.OnClickListener
        public void onClick(View view) {
    ...
    View.OnClickListener mRefreshSmscButtonHandler = new View.OnClickListener() { // from class: com.android.settings.RadioInfo.25
        @Override // android.view.View.OnClickListener
        public void onClick(View view) {
            RadioInfo.this.refreshSmsc();
        }
    };
    View.OnClickListener mCarrierProvisioningButtonHandler = new View.OnClickListener() { // from class: com.android.settings.RadioInfo.26
        @Override // android.view.View.OnClickListener
        public void onClick(View view) {
    ...
    View.OnClickListener mTriggerCarrierProvisioningButtonHandler = new View.OnClickListener() { // from class: com.android.settings.RadioInfo.27
        @Override // android.view.View.OnClickListener
        public void onClick(View view) {
    ...
    AdapterView.OnItemSelectedListener mPreferredNetworkHandler = new AdapterView.OnItemSelectedListener() { // from class: com.android.settings.RadioInfo.28
    ...
    AdapterView.OnItemSelectedListener mCellInfoRefreshRateHandler = new AdapterView.OnItemSelectedListener() { // from class: com.android.settings.RadioInfo.29
        @Override // android.widget.AdapterView.OnItemSelectedListener
        public void onItemSelected(AdapterView adapterView, View view, int i, long j) {
    ...
    public final void updateAllCellInfo() {
        ...
        final Runnable runnable = new Runnable() { // from class: com.android.settings.RadioInfo.4
    ...
    public final void updatePingState() {
        ...
        this.mPingHostnameV6.setText(this.mPingHostnameResultV6);
        this.mHttpClientTest.setText(this.mHttpClientTestResult);
        final Runnable runnable = new Runnable() { // from class: com.android.settings.RadioInfo.6
            @Override // java.lang.Runnable
            public void run() {
    ...
    void setImsConfigProvisionedState(final int i, final boolean z) {
        if (this.phone != null && this.mImsManager != null) {
            QueuedWork.queue(new Runnable() { // from class: com.android.settings.RadioInfo.15
                @Override // java.lang.Runnable
                public void run() {
                    try {
