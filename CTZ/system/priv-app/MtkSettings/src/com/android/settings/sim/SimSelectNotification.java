...
public class SimSelectNotification extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (UtilsExt.shouldDisableForAutoSanity()) {
        ...
        } else if (TelephonyUtils.isAirplaneModeOn(context)) {
            Log.d("SimSelectNotification", "airplane mode is on, ignore.");
        } else if (SystemProperties.getInt("ro.vendor.mtk_external_sim_support", 0) == 1 && SystemProperties.getInt("vendor.gsm.disable.sim.dialog", 0) == 1) {
            ...
            Log.d("SimSelectNotification", "dataSelected=" + isUsableSubIdValue + ", smsSelected=" + isUsableSubIdValue2);
    ...
    private void createNotification(Context context) {
        ...
        Intent intent = new Intent(context, Settings.SimSettingsActivity.class);
