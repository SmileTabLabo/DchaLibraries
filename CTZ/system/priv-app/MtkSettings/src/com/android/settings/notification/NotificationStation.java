...
public class NotificationStation extends SettingsPreferenceFragment {
    ...
    public static class HistoricalNotificationPreference extends Preference {
        ...
        public void onBindViewHolder(PreferenceViewHolder preferenceViewHolder) {
            ...
            preferenceViewHolder.itemView.setOnClickListener(new View.OnClickListener() { // from class: com.android.settings.notification.NotificationStation.HistoricalNotificationPreference.1
