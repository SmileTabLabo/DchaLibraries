...
public class CachedStorageValuesHelper {
    ...
    public CachedStorageValuesHelper(Context context, int i) {
        ...
        this.mUserId = i;
        this.mClobberThreshold = Long.valueOf(Settings.Global.getLong(context.getContentResolver(), "storage_settings_clobber_threshold", TimeUnit.MINUTES.toMillis(5L)));
    }
