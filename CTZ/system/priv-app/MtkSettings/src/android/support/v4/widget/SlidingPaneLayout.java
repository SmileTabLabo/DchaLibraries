    ...
    */
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (widthMode != 1073741824) {
            ...
            if (heightMode2 == 0) {
                heightMode2 = AccessPoint.UNREACHABLE_RSSI;
                heightSize2 = 300;
            }
        }
        int layoutHeight = 0;
        ...
        while (true) {
            ...
            if (child.getVisibility() == 8) {
                ...
                if (lp.width == -2) {
                    childWidthSpec = View.MeasureSpec.makeMeasureSpec(widthAvailable - horizontalMargin, AccessPoint.UNREACHABLE_RSSI);
                } else {
                ...
                int childHeightSpec3 = lp.height == -2 ? View.MeasureSpec.makeMeasureSpec(maxLayoutHeight2, AccessPoint.UNREACHABLE_RSSI) : lp.height == -1 ? View.MeasureSpec.makeMeasureSpec(maxLayoutHeight2, 1073741824) : View.MeasureSpec.makeMeasureSpec(lp.height, 1073741824);
                        ...
                        if (!canSlide || child2 == this.mSlideableView) {
                            ...
                            if (lp2.weight > 0.0f) {
                                if (lp2.width != 0) {
                                    ...
                                    int childHeightSpec5 = View.MeasureSpec.makeMeasureSpec(maxLayoutHeight2, AccessPoint.UNREACHABLE_RSSI);
                            ...
                            if (skippedFirstPass) {
                                childCount = childCount2;
                                if (lp2.height == -2) {
                                    childHeightSpec2 = View.MeasureSpec.makeMeasureSpec(maxLayoutHeight2, AccessPoint.UNREACHABLE_RSSI);
                                    i2 = 1073741824;
                                } else if (lp2.height == -1) {
                                    i2 = 1073741824;
