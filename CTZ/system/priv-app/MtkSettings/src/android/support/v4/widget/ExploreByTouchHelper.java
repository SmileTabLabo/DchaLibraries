...
public abstract class ExploreByTouchHelper extends AccessibilityDelegateCompat {
    private static final Rect INVALID_PARENT_BOUNDS = new Rect(Preference.DEFAULT_ORDER, Preference.DEFAULT_ORDER, AccessPoint.UNREACHABLE_RSSI, AccessPoint.UNREACHABLE_RSSI);
    ...
    private int mAccessibilityFocusedVirtualViewId = AccessPoint.UNREACHABLE_RSSI;
    private int mKeyboardFocusedVirtualViewId = AccessPoint.UNREACHABLE_RSSI;
    private int mHoveredVirtualViewId = AccessPoint.UNREACHABLE_RSSI;
                ...
                switch (action) {
                    ...
                    case 10:
                        if (this.mHoveredVirtualViewId != Integer.MIN_VALUE) {
                            updateHoveredVirtualView(AccessPoint.UNREACHABLE_RSSI);
                            return true;
                        }
                        return false;
                    default:
    ...
    private boolean clearAccessibilityFocus(int virtualViewId) {
        if (this.mAccessibilityFocusedVirtualViewId == virtualViewId) {
            this.mAccessibilityFocusedVirtualViewId = AccessPoint.UNREACHABLE_RSSI;
            this.mHost.invalidate();
    ...
    public final boolean clearKeyboardFocusForVirtualView(int virtualViewId) {
        ...
        this.mKeyboardFocusedVirtualViewId = AccessPoint.UNREACHABLE_RSSI;
