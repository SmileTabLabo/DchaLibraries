...
public class LinearLayoutCompat extends ViewGroup {
    ...
    public int getBaseline() {
        ...
        if (this.mOrientation == 1 && (majorGravity = this.mGravity & R.styleable.AppCompatTheme_windowActionBarOverlay) != 48) {
            if (majorGravity == 16) {
                ...
                if (child2 == null) {
                    ...
                    if (childState6 == 8) {
                        ...
                        if (heightMode4 == 1073741824 && lp2.height == 0 && lp2.weight > 0.0f) {
                            ...
                            this.mTotalLength = Math.max(totalLength, lp2.topMargin + totalLength + i8);
                            lp = lp2;
                            child = child2;
                            ...
                            int i9 = maxWidth2;
                            int oldHeight = AccessPoint.UNREACHABLE_RSSI;
                        ...
                        int allFillParent3 = (largestChildHeight2 == 0 || lp.width != i4) ? 0 : 1;
                        if (lp.weight > 0.0f) {
                            allFillParent2 = allFillParent3;
                            weightedMaxWidth3 = Math.max(weightedMaxWidth2, matchWidthLocally2 ? margin3 : measuredWidth);
                        } else {
                            allFillParent2 = allFillParent3;
                            weightedMaxWidth3 = weightedMaxWidth2;
                            alternativeMaxWidth3 = Math.max(alternativeMaxWidth3, matchWidthLocally2 ? margin3 : measuredWidth);
                        }
                    ...
                    if (heightMode == Integer.MIN_VALUE || heightMode == 0) {
                        ...
                        while (i10 < count) {
                            ...
                            if (child3 == null) {
                                ...
                                this.mTotalLength = Math.max(totalLength3, totalLength3 + largestChildHeight4 + i11 + lp3.bottomMargin + getNextLocationOffset(child3));
                                i10 = i + 1;
                            }
                            i = i10;
                            i10 = i + 1;
                            ...
                            while (true) {
                                ...
                                if (child4 != null) {
                                    ...
                                    if (child4.getVisibility() == 8) {
                                        ...
                                        child4.measure(makeMeasureSpec, alternativeMaxWidth8);
                                    } else {
                                        alternativeMaxWidth2 = alternativeMaxWidth7;
                                    }
                                } else {
                    ...
                    if (child5.getVisibility() == 8) {
                        ...
                        if (widthMode != 1073741824) {
                            ...
                            if (lp4.width == -1) {
                                ...
                                alternativeMaxWidth6 = Math.max(alternativeMaxWidth6, !matchWidthLocally ? margin : measuredWidth2);
    ...
    */
    void measureHorizontal(int widthMeasureSpec, int heightMeasureSpec) {
                ...
                if (largestChildWidth7 == 8) {
                    ...
                    if (widthMode == 1073741824 && lp2.width == 0 && lp2.weight > 0.0f) {
                        ...
                        if (baselineAligned2) {
                            ...
                            int i142 = i4;
                            maxHeight5 = i142 + getChildrenSkipCount(child, i142);
                            childState2 = childState42;
                            matchHeight = allFillParent;
                            weightedMaxHeight5 = weightedMaxHeight4;
                            totalWeight = totalWeight2;
                            largestChildWidth2 = largestChildWidth6;
                            childState3 = maxHeight62;
                            alternativeMaxHeight5 = weightedMaxHeight3;
                        }
                    } else {
                        int i15 = maxHeight5;
                        int oldWidth = AccessPoint.UNREACHABLE_RSSI;
                        ...
                        maxHeight4 = childState3;
                        int maxHeight7 = totalWeight2 == 0.0f ? this.mTotalLength : 0;
                        int oldWidth3 = i9;
                        baselineAligned = baselineAligned2;
                        i5 = -1;
                        measureChildBeforeLayout(child, i4, alternativeMaxHeight6, maxHeight7, oldWidth3, 0);
                        ...
                        if (useLargestChild2) {
                            ...
                            if (baselineAligned || (childBaseline = child.getBaseline()) == i5) {
                                ...
                                int gravity = (lp.gravity < 0 ? this.mGravity : lp.gravity) & R.styleable.AppCompatTheme_windowActionBarOverlay;
                            ...
                            if (lp.weight <= 0.0f) {
                                weightedMaxHeight3 = Math.max(weightedMaxHeight2, matchHeightLocally2 ? margin2 : childHeight22);
                                weightedMaxHeight4 = alternativeMaxHeight4;
                            } else {
                                weightedMaxHeight3 = weightedMaxHeight2;
                                weightedMaxHeight4 = Math.max(alternativeMaxHeight4, matchHeightLocally2 ? margin2 : childHeight22);
                            }
                            int i1422 = i4;
                            maxHeight5 = i1422 + getChildrenSkipCount(child, i1422);
                            childState2 = childState422;
                            matchHeight = allFillParent2;
                            weightedMaxHeight5 = weightedMaxHeight4;
                            totalWeight = totalWeight2;
                            largestChildWidth2 = largestChildWidth6;
                            childState3 = maxHeight622;
                            alternativeMaxHeight5 = weightedMaxHeight3;
                        } else {
                            i6 = largestChildWidth6;
                            largestChildWidth6 = i6;
                            ...
                            int i14222 = i4;
                            maxHeight5 = i14222 + getChildrenSkipCount(child, i14222);
                            childState2 = childState4222;
                            matchHeight = allFillParent2;
                            weightedMaxHeight5 = weightedMaxHeight4;
                            totalWeight = totalWeight2;
                            largestChildWidth2 = largestChildWidth6;
                            childState3 = maxHeight6222;
                            alternativeMaxHeight5 = weightedMaxHeight3;
                        }
                    }
                }
            ...
            while (i19 < count3) {
                ...
                if (child2 == null) {
                    ...
                    if (isExactly) {
                        ...
                        i2 = i19;
                        int i21 = lp3.rightMargin;
                        this.mTotalLength = i20 + lp3.leftMargin + largestChildWidth8 + i21 + getNextLocationOffset(child2);
                    } else {
                        i2 = i19;
                        int i22 = this.mTotalLength;
                        this.mTotalLength = Math.max(i22, i22 + largestChildWidth8 + lp3.leftMargin + lp3.rightMargin + getNextLocationOffset(child2));
                    }
                }
                i3 = i2;
                i19 = i3 + 1;
        ...
        this.mTotalLength = i23 + getPaddingLeft() + getPaddingRight();
        ...
        if (!skippedMeasure && (delta2 == 0 || totalWeight <= 0.0f)) {
            int alternativeMaxHeight7 = Math.max(weightedMaxHeight5, weightedMaxHeight7);
                ...
                while (true) {
                    ...
                    if (child3 != null) {
                        ...
                        if (alternativeMaxHeight8 == 8) {
                            ...
                            int makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(largestChildWidth8, 1073741824);
                            largestChildWidth = largestChildWidth8;
                            int largestChildWidth9 = child3.getMeasuredHeight();
                            child3.measure(makeMeasureSpec, View.MeasureSpec.makeMeasureSpec(largestChildWidth9, 1073741824));
                        } else {
                            largestChildWidth = largestChildWidth8;
                        }
                    } else {
        ...
        while (i26 < count3) {
            ...
            View child4 = getVirtualChildAt(i26);
            if (child4 != null) {
                weightedMaxHeight = weightedMaxHeight7;
                int weightedMaxHeight8 = child4.getVisibility();
                useLargestChild = useLargestChild2;
                if (weightedMaxHeight8 == 8) {
                    ...
                    if (childExtra > 0.0f) {
                        ...
                        childState7 = View.combineMeasuredStates(childState7, child4.getMeasuredState() & (-16777216));
                    } else {
                        count2 = count3;
                    ...
                    boolean matchHeightLocally3 = heightMode != 1073741824 && lp4.height == -1;
                    ...
                    int alternativeMaxHeight9 = Math.max(alternativeMaxHeight, matchHeightLocally3 ? margin3 : childHeight3);
                    if (matchHeight && lp4.height == -1) {
                        ...
                        if (baselineAligned3) {
                            ...
                            allFillParent = matchHeightLocally;
                            if (childBaseline2 != -1) {
                                int gravity2 = (lp4.gravity < 0 ? this.mGravity : lp4.gravity) & R.styleable.AppCompatTheme_windowActionBarOverlay;
                                int index2 = ((gravity2 >> 4) & (-2)) >> 1;
                                int gravity3 = maxAscent[index2];
                                maxAscent[index2] = Math.max(gravity3, childBaseline2);
                                alternativeMaxHeight2 = alternativeMaxHeight9;
                                int alternativeMaxHeight10 = childHeight3 - childBaseline2;
                                maxDescent[index2] = Math.max(maxDescent[index2], alternativeMaxHeight10);
                            } else {
                                alternativeMaxHeight2 = alternativeMaxHeight9;
                            }
                        }
    ...
    void layoutVertical(int left, int top, int right, int bottom) {
        ...
        int count = getVirtualChildCount();
        int majorGravity2 = this.mGravity & R.styleable.AppCompatTheme_windowActionBarOverlay;
    ...
    */
    void layoutHorizontal(int left, int top, int right, int bottom) {
        ...
        int minorGravity = this.mGravity & R.styleable.AppCompatTheme_windowActionBarOverlay;
        boolean baselineAligned2 = this.mBaselineAligned;
                ...
                if (i4 == 8) {
                    ...
                    if (baselineAligned2) {
                        ...
                        if (lp.height != -1) {
                            ...
                            i = gravity & R.styleable.AppCompatTheme_windowActionBarOverlay;
                            count = count2;
                            if (i != 16) {
    ...
    public void setGravity(int gravity) {
        if (this.mGravity != gravity) {
            ...
            if ((gravity & R.styleable.AppCompatTheme_windowActionBarOverlay) == 0) {
                gravity |= 48;
            }
    ...
    public void setVerticalGravity(int verticalGravity) {
        int gravity = verticalGravity & R.styleable.AppCompatTheme_windowActionBarOverlay;
        if ((this.mGravity & R.styleable.AppCompatTheme_windowActionBarOverlay) != gravity) {
