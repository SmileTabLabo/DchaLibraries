...
/* loaded from: a.zip:com/android/quicksearchbox/SearchWidgetProvider.class */
public class SearchWidgetProvider extends BroadcastReceiver {

    /* JADX INFO: Access modifiers changed from: private */
    /* loaded from: a.zip:com/android/quicksearchbox/SearchWidgetProvider$SearchWidgetState.class */
    public static class SearchWidgetState {
        ...
        public void updateWidget(Context context, AppWidgetManager appWidgetManager) {
            ...
            if (4 != (context.getResources().getConfiguration().screenLayout & 4)) {
                setOnClickActivityIntent(context, remoteViews, 2131689492, this.mQueryTextViewIntent);
            }
