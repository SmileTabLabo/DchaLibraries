...
@GwtCompatible
/* loaded from: a.zip:com/google/common/collect/Ordering.class */
public abstract class Ordering<T> implements Comparator<T> {

    @VisibleForTesting
    /* loaded from: a.zip:com/google/common/collect/Ordering$ArbitraryOrdering.class */
    ...
    @VisibleForTesting
    /* loaded from: a.zip:com/google/common/collect/Ordering$IncomparableValueException.class */
