...
/* loaded from: a.zip:com/google/common/collect/ImmutableBiMap.class */
public abstract class ImmutableBiMap<K, V> extends ImmutableMap<K, V> implements BiMap<K, V> {
    private static final Map.Entry<?, ?>[] EMPTY_ENTRY_ARRAY = new Map.Entry[0];

    /* loaded from: a.zip:com/google/common/collect/ImmutableBiMap$Builder.class */
    ...
    /* loaded from: a.zip:com/google/common/collect/ImmutableBiMap$SerializedForm.class */
