...
/* loaded from: a.zip:com/google/common/collect/RegularImmutableSortedMap.class */
public final class RegularImmutableSortedMap<K, V> extends ImmutableSortedMap<K, V> {
    private final transient RegularImmutableSortedSet<K> keySet;
    private final transient ImmutableList<V> valueList;

    /* JADX INFO: Access modifiers changed from: private */
    /* loaded from: a.zip:com/google/common/collect/RegularImmutableSortedMap$EntrySet.class */
