...
/* loaded from: a.zip:com/google/common/collect/ImmutableMapKeySet.class */
final class ImmutableMapKeySet<K, V> extends ImmutableSet<K> {
    private final ImmutableMap<K, V> map;

    @GwtIncompatible("serialization")
    /* loaded from: a.zip:com/google/common/collect/ImmutableMapKeySet$KeySetSerializedForm.class */
