...
@GwtCompatible
/* loaded from: a.zip:com/google/common/collect/AbstractIterator.class */
public abstract class AbstractIterator<T> extends UnmodifiableIterator<T> {
    ...
    /* loaded from: a.zip:com/google/common/collect/AbstractIterator$State.class */
    public enum State {
        READY,
        NOT_READY,
        DONE,
    ...
    private static /* synthetic */ int[] m44x50f87187() {
    ...
    public final boolean hasNext() {
        ...
        switch (m44x50f87187()[this.state.ordinal()]) {
            case 1:
                return false;
            case 2:
                return true;
