...
/* loaded from: a.zip:com/google/common/collect/ImmutableMapValues.class */
public final class ImmutableMapValues<K, V> extends ImmutableCollection<V> {
    private final ImmutableMap<K, V> map;

    @GwtIncompatible("serialization")
    /* loaded from: a.zip:com/google/common/collect/ImmutableMapValues$SerializedForm.class */
