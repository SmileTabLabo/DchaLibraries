...
/* loaded from: a.zip:com/android/launcher3/LogDecelerateInterpolator.class */
public class LogDecelerateInterpolator implements TimeInterpolator {
    ...
    public float getInterpolation(float f) {
        return Float.compare(f, 1.0f) == 0 ? 1.0f : computeLog(f, this.mBase, this.mDrift) * this.mLogScale;
    }
}
