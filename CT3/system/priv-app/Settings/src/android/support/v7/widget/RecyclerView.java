...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild {
    ...
    public View focusSearch(View focused, int direction) {
        ...
        if (this.mAdapter == null || this.mLayout == null || isComputingLayout()) {
            ...
            canRunFocusFailure = !this.mLayoutFrozen;
        }
    ...
    public void onMeasure(int widthSpec, int heightSpec) {
        ...
        if (this.mLayout == null) {
            ...
            if (widthMode != 1073741824) {
                ...
                skipMeasure = heightMode == 1073741824;
            }
    ...
    private void processAdapterUpdatesAndSetAnimationFlags() {
        ...
        this.mState.mRunSimpleAnimations = (this.mFirstLayoutComplete && this.mItemAnimator != null && (this.mDataSetHasChangedAfterLayout || z2 || this.mLayout.mRequestedSimpleAnimations)) ? this.mDataSetHasChangedAfterLayout ? this.mAdapter.hasStableIds() : true : false;
