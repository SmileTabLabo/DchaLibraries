...
public class DefaultItemAnimator extends SimpleItemAnimator {
    ...
    public static class MoveInfo {
        ...
        /* synthetic */ MoveInfo(RecyclerView.ViewHolder holder, int fromX, int fromY, int toX, int toY, MoveInfo moveInfo) {
    ...
    public static class ChangeInfo {
        ...
        /* synthetic */ ChangeInfo(RecyclerView.ViewHolder oldHolder, RecyclerView.ViewHolder newHolder, int fromX, int fromY, int toX, int toY, ChangeInfo changeInfo) {
    ...
    public boolean animateMove(RecyclerView.ViewHolder holder, int fromX, int fromY, int toX, int toY) {
        ...
        this.mPendingMoves.add(new MoveInfo(holder, fromX2, fromY2, toX, toY, null));
        return true;
    }
