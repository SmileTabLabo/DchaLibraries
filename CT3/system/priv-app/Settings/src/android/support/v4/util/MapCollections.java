...
public abstract class MapCollections<K, V> {
        ...
        public final boolean equals(Object o) {
            ...
            if (o instanceof Map.Entry) {
                ...
                if (ContainerHelpers.equal(e.getKey(), MapCollections.this.colGetEntry(this.mIndex, 0))) {
                    return ContainerHelpers.equal(e.getValue(), MapCollections.this.colGetEntry(this.mIndex, 1));
                }
                return false;
            }
            return false;
    ...
    final class EntrySet implements Set<Map.Entry<K, V>> {
        ...
        public /* bridge */ /* synthetic */ boolean add(Object object) {
            return add((Map.Entry) ((Map.Entry) object));
        }
