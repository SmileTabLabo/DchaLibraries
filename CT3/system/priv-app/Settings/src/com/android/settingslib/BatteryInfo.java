...
public class BatteryInfo {
    ...
    public void bindHistory(final UsageView view, BatteryDataParser... parsers) {
        BatteryDataParser parser = new BatteryDataParser() { // from class: com.android.settingslib.BatteryInfo.1
        ...
        if (stats.startIteratingHistoryLocked()) {
            ...
            while (stats.getNextHistoryLocked(rec)) {
                ...
                if (rec.cmd == 5 || rec.cmd == 7) {
                    startWalltime = (rec.currentTime > 15552000000L + lastWallTime || rec.time < 300000 + historyStart) ? 0L : 0L;
