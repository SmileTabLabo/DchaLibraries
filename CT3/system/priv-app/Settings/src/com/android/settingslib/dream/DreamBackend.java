...
public class DreamBackend {
    ...
    public DreamBackend(Context context) {
        ...
        this.mDreamsEnabledByDefault = context.getResources().getBoolean(17956971);
        this.mDreamsActivatedOnSleepByDefault = context.getResources().getBoolean(17956973);
        this.mDreamsActivatedOnDockByDefault = context.getResources().getBoolean(17956972);
    }
