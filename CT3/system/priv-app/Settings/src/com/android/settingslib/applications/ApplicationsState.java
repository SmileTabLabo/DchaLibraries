...
public class ApplicationsState {
                ...
                if (!info.enabled) {
                    ...
                    while (true) {
                        if (i >= this.mApplications.size()) {
                            break;
                        } else if (this.mApplications.get(i).enabled) {
                            i++;
                        } else {
                            this.mHaveDisabledApps = true;
                            break;
    ...
    public class PackageIntentReceiver extends BroadcastReceiver {
        /* synthetic */ PackageIntentReceiver(ApplicationsState this$0, PackageIntentReceiver packageIntentReceiver) {
            this();
        }
    ...
    public static class AppEntry extends SizeInfo {
        ...
        boolean ensureIconLocked(Context context, PackageManager pm) {
            if (this.icon == null) {
                ...
                this.mounted = false;
                this.icon = context.getDrawable(17303334);
