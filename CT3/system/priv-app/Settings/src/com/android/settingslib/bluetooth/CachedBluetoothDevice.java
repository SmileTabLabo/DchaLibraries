...
public class CachedBluetoothDevice implements Comparable<CachedBluetoothDevice> {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public CachedBluetoothDevice(Context context, LocalBluetoothAdapter adapter, LocalBluetoothProfileManager profileManager, BluetoothDevice device) {
    ...
    */
    public boolean isBusy() {
        for (LocalBluetoothProfile profile : this.mProfiles) {
            ...
            while (profile$iterator.hasNext()) {
            }
        }
