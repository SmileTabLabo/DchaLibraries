...
public class DisplayDensityUtils {
    ...
    public static void clearForcedDisplayDensity(final int displayId) {
        AsyncTask.execute(new Runnable() { // from class: com.android.settingslib.display.DisplayDensityUtils.1
    ...
    public static void setForcedDisplayDensity(final int displayId, final int density) {
        AsyncTask.execute(new Runnable() { // from class: com.android.settingslib.display.DisplayDensityUtils.2
            @Override // java.lang.Runnable
            public void run() {
                try {
                    IWindowManager wm = WindowManagerGlobal.getWindowManagerService();
