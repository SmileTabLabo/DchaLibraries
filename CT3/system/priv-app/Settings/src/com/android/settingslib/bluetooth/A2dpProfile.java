...
public final class A2dpProfile implements LocalBluetoothProfile {
    ...
    private final class A2dpServiceListener implements BluetoothProfile.ServiceListener {
        /* synthetic */ A2dpServiceListener(A2dpProfile this$0, A2dpServiceListener a2dpServiceListener) {
            this();
        }
    ...
    public A2dpProfile(Context context, LocalBluetoothAdapter adapter, CachedBluetoothDeviceManager deviceManager, LocalBluetoothProfileManager profileManager) {
