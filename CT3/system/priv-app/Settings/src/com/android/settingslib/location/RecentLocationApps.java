...
public class RecentLocationApps {
    ...
    public static class Request {
        ...
        /* synthetic */ Request(String packageName, UserHandle userHandle, Drawable icon, CharSequence label, boolean isHighBattery, CharSequence contentDescription, Request request) {
