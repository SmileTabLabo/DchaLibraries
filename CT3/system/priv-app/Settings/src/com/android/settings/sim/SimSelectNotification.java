...
public class SimSelectNotification extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        } else if (!dataSelected || SystemProperties.get("ro.cmcc_light_cust_support").equals("1")) {
            Intent newIntent2 = new Intent(context, SimDialogActivity.class);
    ...
    private void createNotification(Context context) {
        ...
        Intent resultIntent = new Intent(context, Settings.SimSettingsActivity.class);
