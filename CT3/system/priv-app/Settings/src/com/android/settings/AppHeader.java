...
public class AppHeader {
    ...
    public static View setupHeaderView(final Activity activity, Drawable icon, CharSequence label, final String pkgName, final int uid, final boolean includeAppInfo, int tintColorRes, View bar, final Intent externalSettings) {
        ...
        if (pkgName != null && !pkgName.equals("os")) {
            ...
            bar.setOnClickListener(new View.OnClickListener() { // from class: com.android.settings.AppHeader.1
                @Override // android.view.View.OnClickListener
                public void onClick(View v) {
                    if (includeAppInfo) {
                        AppInfoBase.startAppInfoFragment(InstalledAppDetails.class, (int) R.string.application_info_label, pkgName, uid, activity, 1);
                    } else {
                        activity.finish();
                    }
                }
            ...
            if (externalSettings != null) {
                ...
                appSettings.setOnClickListener(new View.OnClickListener() { // from class: com.android.settings.AppHeader.2
                    @Override // android.view.View.OnClickListener
                    public void onClick(View v) {
