...
public class AppDataUsage extends DataUsageBase implements Preference.OnPreferenceChangeListener, DataSaverBackend.Listener {
    ...
    private final LoaderManager.LoaderCallbacks<ChartData> mChartDataCallbacks = new LoaderManager.LoaderCallbacks<ChartData>() { // from class: com.android.settings.datausage.AppDataUsage.2
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        if (valueAt != null) {
            try {
                uid = getPackageManager().getPackageUid(valueAt, 0);
            } catch (PackageManager.NameNotFoundException e) {
            }
        } else {
            uid = 0;
        }
        AppHeader.setupHeaderView(getActivity(), this.mIcon, this.mLabel, valueAt, uid, AppHeader.includeAppInfo(this), 0, header, null);
    }
    ...
    private class AppPrefLoader extends AsyncTask<String, Void, Preference> {
        /* synthetic */ AppPrefLoader(AppDataUsage this$0, AppPrefLoader appPrefLoader) {
            this();
        }
