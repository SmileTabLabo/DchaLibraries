...
public class LocaleDragAndDropAdapter extends RecyclerView.Adapter<CustomViewHolder> {
    ...
    public void onBindViewHolder(CustomViewHolder holder, int i) {
        ...
        dragCell.getCheckbox().setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: com.android.settings.localepicker.LocaleDragAndDropAdapter.2
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void addLocale(LocaleStore.LocaleInfo li) {
    ...
    public void updateLocalesWhenAnimationStops(LocaleList localeList) {
        ...
        itemAnimator.isRunning(new RecyclerView.ItemAnimator.ItemAnimatorFinishedListener() { // from class: com.android.settings.localepicker.LocaleDragAndDropAdapter.3
