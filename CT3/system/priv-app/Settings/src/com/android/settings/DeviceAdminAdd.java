    ...
    protected void onCreate(Bundle icicle) {
        ...
        try {
            ...
            try {
                ...
                this.mActionButton.setOnClickListener(new View.OnClickListener() { // from class: com.android.settings.DeviceAdminAdd.5
                    @Override // android.view.View.OnClickListener
                    public void onClick(View v) {
                        if (DeviceAdminAdd.this.mAdding) {
                            ...
                            UserDialogs.createRemoveDialog(DeviceAdminAdd.this, userId, new DialogInterface.OnClickListener() { // from class: com.android.settings.DeviceAdminAdd.5.1
    ...
    protected Dialog onCreateDialog(int id, Bundle args) {
        switch (id) {
            case 1:
                ...
                builder.setPositiveButton(R.string.dlg_ok, new DialogInterface.OnClickListener() { // from class: com.android.settings.DeviceAdminAdd.6
                    @Override // android.content.DialogInterface.OnClickListener
                    public void onClick(DialogInterface dialog, int which) {
                        try {
                            ActivityManagerNative.getDefault().resumeAppSwitches();
