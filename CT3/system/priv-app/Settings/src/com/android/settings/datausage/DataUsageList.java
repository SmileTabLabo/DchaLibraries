...
public class DataUsageList extends DataUsageBase {
    ...
    private AdapterView.OnItemSelectedListener mCycleListener = new AdapterView.OnItemSelectedListener() { // from class: com.android.settings.datausage.DataUsageList.1
    ...
    private final LoaderManager.LoaderCallbacks<ChartData> mChartDataCallbacks = new LoaderManager.LoaderCallbacks<ChartData>() { // from class: com.android.settings.datausage.DataUsageList.2
    ...
    private final LoaderManager.LoaderCallbacks<NetworkStats> mSummaryCallbacks = new LoaderManager.LoaderCallbacks<NetworkStats>() { // from class: com.android.settings.datausage.DataUsageList.3
        @Override // android.app.LoaderManager.LoaderCallbacks
    ...
    @Override // com.android.settings.datausage.DataUsageBase, com.android.settings.SettingsPreferenceFragment, android.support.v14.preference.PreferenceFragment, android.app.Fragment
    ...
    public void onViewCreated(View v, Bundle savedInstanceState) {
        ...
        this.mCycleAdapter = new CycleAdapter(getContext(), new CycleAdapter.SpinnerInterface() { // from class: com.android.settings.datausage.DataUsageList.4
    ...
    /* JADX WARN: Type inference failed for: r0v0, types: [com.android.settings.datausage.DataUsageList$5] */
    @Override // com.android.settings.datausage.DataUsageBase, com.android.settings.SettingsPreferenceFragment, com.android.settings.InstrumentedPreferenceFragment, android.app.Fragment
    public void onResume() {
        super.onResume();
        updateBody();
        new AsyncTask<Void, Void, Void>() { // from class: com.android.settings.datausage.DataUsageList.5
    ...
    public void updatePolicy(boolean refreshCycle) {
        ...
        if (isNetworkPolicyModifiable(policy, this.mSubId) && isMobileDataAvailable(this.mSubId)) {
            ...
            this.mHeader.findViewById(R.id.filter_settings).setOnClickListener(new View.OnClickListener() { // from class: com.android.settings.datausage.DataUsageList.6
    ...
    public void bindStats(NetworkStats stats, int[] restrictedUids) {
        ...
        for (int i2 = 0; i2 < items.size(); i2++) {
            ...
            preference.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() { // from class: com.android.settings.datausage.DataUsageList.7
