...
public abstract class NotificationSettingsBase extends SettingsPreferenceFragment {
    ...
    public void setupImportancePrefs(boolean isSystemApp, int importance, boolean banned) {
        if (this.mShowSlider) {
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public void setupPriorityPref(boolean priority) {
        this.mPriority.setDisabledByAdmin(this.mSuspendedAppsAdmin);
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public void setupVisOverridePref(int sensitive) {
