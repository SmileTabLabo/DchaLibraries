...
public abstract class CustomPreviewSeekBarPreferenceFragment extends SettingsPreferenceFragment {
    ...
    private ViewPager.OnPageChangeListener mPreviewPageChangeListener = new ViewPager.OnPageChangeListener() { // from class: com.android.settings.CustomPreviewSeekBarPreferenceFragment.1
    ...
    private ViewPager.OnPageChangeListener mPageIndicatorPageChangeListener = new ViewPager.OnPageChangeListener() { // from class: com.android.settings.CustomPreviewSeekBarPreferenceFragment.2
        @Override // android.support.v4.view.ViewPager.OnPageChangeListener
        public void onPageScrollStateChanged(int state) {
        }
    ...
    private class onPreviewSeekBarChangeListener implements SeekBar.OnSeekBarChangeListener {
        ...
        /* synthetic */ onPreviewSeekBarChangeListener(CustomPreviewSeekBarPreferenceFragment this$0, onPreviewSeekBarChangeListener onpreviewseekbarchangelistener) {
            this();
        }
        ...
        private void showDialog(final Activity activity, final SeekBar seekBar, final int value) {
            ...
            builder.setOnCancelListener(new DialogInterface.OnCancelListener() { // from class: com.android.settings.CustomPreviewSeekBarPreferenceFragment.onPreviewSeekBarChangeListener.1
            ...
            builder.setPositiveButton(this.context.getString(R.string.positive_button_title), new DialogInterface.OnClickListener() { // from class: com.android.settings.CustomPreviewSeekBarPreferenceFragment.onPreviewSeekBarChangeListener.2
            ...
            builder.setNegativeButton(this.context.getString(R.string.negative_button_title), new DialogInterface.OnClickListener() { // from class: com.android.settings.CustomPreviewSeekBarPreferenceFragment.onPreviewSeekBarChangeListener.3
                @Override // android.content.DialogInterface.OnClickListener
                public void onClick(DialogInterface dialog, int which) {
        ...
        public void onStopTrackingTouch(SeekBar seekBar) {
            if (CustomPreviewSeekBarPreferenceFragment.this.mPreviewPagerAdapter.isAnimating()) {
                ...
                CustomPreviewSeekBarPreferenceFragment.this.mPreviewPagerAdapter.setAnimationEndAction(new Runnable() { // from class: com.android.settings.CustomPreviewSeekBarPreferenceFragment.onPreviewSeekBarChangeListener.4
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        this.mSmaller.setOnClickListener(new View.OnClickListener() { // from class: com.android.settings.CustomPreviewSeekBarPreferenceFragment.3
        ...
        this.mLarger.setOnClickListener(new View.OnClickListener() { // from class: com.android.settings.CustomPreviewSeekBarPreferenceFragment.4
            @Override // android.view.View.OnClickListener
            public void onClick(View v) {
                int progress = seekBar.getProgress();
