...
public class InstalledAppDetails extends AppInfoBase implements View.OnClickListener, Preference.OnPreferenceClickListener {
    ...
    public void onResume() {
        ...
        new BatteryUpdater(this, null).execute(new Void[0]);
        new MemoryUpdater(this, null).execute(new Void[0]);
        updateDynamicPrefs();
    }

    @Override // com.android.settings.applications.AppInfoBase, com.android.settings.InstrumentedPreferenceFragment, android.app.Fragment
    public void onPause() {
        getLoaderManager().destroyLoader(2);
        super.onPause();
    }

    @Override // com.android.settings.applications.AppInfoBase, android.app.Fragment
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        if (this.mAppEntry != null && this.mAppEntry.info != null) {
            if ((this.mAppEntry.info.flags & 8388608) == 0 || !this.mAppEntry.info.enabled) {
    ...
    private void handleHeader() {
        ...
        if (intent != null) {
            ...
            gear.setOnClickListener(new View.OnClickListener() { // from class: com.android.settings.applications.InstalledAppDetails.4
    ...
    private void updateBattery() {
        ...
        int percentOfMax = (int) (((this.mSipper.totalPowerMah / this.mBatteryHelper.getTotalPower()) * dischargeAmount) + 0.5d);
    ...
    protected AlertDialog createDialog(int id, int errorCode) {
        switch (id) {
            case 1:
                return new AlertDialog.Builder(getActivity()).setTitle(getActivity().getText(R.string.force_stop_dlg_title)).setMessage(getActivity().getText(R.string.force_stop_dlg_text)).setPositiveButton(R.string.dlg_ok, new DialogInterface.OnClickListener() { // from class: com.android.settings.applications.InstalledAppDetails.7
            ...
            case 2:
                return new AlertDialog.Builder(getActivity()).setMessage(getActivity().getText(R.string.app_disable_dlg_text)).setPositiveButton(R.string.app_disable_dlg_positive, new DialogInterface.OnClickListener() { // from class: com.android.settings.applications.InstalledAppDetails.5
                    @Override // android.content.DialogInterface.OnClickListener
                    public void onClick(DialogInterface dialog, int which) {
                        new DisableChanger(InstalledAppDetails.this, InstalledAppDetails.this.mAppEntry.info, 3).execute(null);
                    }
                }).setNegativeButton(R.string.dlg_cancel, (DialogInterface.OnClickListener) null).create();
            case 3:
                return new AlertDialog.Builder(getActivity()).setMessage(getActivity().getText(R.string.app_disable_dlg_text)).setPositiveButton(R.string.app_disable_dlg_positive, new DialogInterface.OnClickListener() { // from class: com.android.settings.applications.InstalledAppDetails.6
                    @Override // android.content.DialogInterface.OnClickListener
                    public void onClick(DialogInterface dialog, int which) {
    ...
    public void onClick(View v) {
        ...
        if (v == this.mUninstallButton) {
            ...
            if (this.mAppsControlDisallowedBySystem) {
                ...
                z = RestrictedLockUtils.hasBaseUserRestriction(getActivity(), packageName, this.mUserId);
            }
            if (admin != null && !z) {
    ...
    private void addDynamicPrefs() {
        ...
        if (hasDrawOverOtherApps || hasWriteSettings) {
            ...
            if (hasDrawOverOtherApps) {
                ...
                pref.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() { // from class: com.android.settings.applications.InstalledAppDetails.8
                    @Override // android.support.v7.preference.Preference.OnPreferenceClickListener
                    public boolean onPreferenceClick(Preference preference) {
            ...
            if (hasWriteSettings) {
                ...
                pref2.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() { // from class: com.android.settings.applications.InstalledAppDetails.9
                    @Override // android.support.v7.preference.Preference.OnPreferenceClickListener
                    public boolean onPreferenceClick(Preference preference) {
    ...
    public static void setupAppSnippet(View appSnippet, CharSequence label, Drawable icon, CharSequence versionName) {
        ...
        ImageView iconView = (ImageView) appSnippet.findViewById(16908294);
        iconView.setImageDrawable(icon);
        TextView labelView = (TextView) appSnippet.findViewById(16908310);
    ...
    private class MemoryUpdater extends AsyncTask<Void, Void, ProcStatsPackageEntry> {
        /* synthetic */ MemoryUpdater(InstalledAppDetails this$0, MemoryUpdater memoryUpdater) {
            this();
        }
    ...
    private class BatteryUpdater extends AsyncTask<Void, Void, Void> {
        /* synthetic */ BatteryUpdater(InstalledAppDetails this$0, BatteryUpdater batteryUpdater) {
            this();
        }
