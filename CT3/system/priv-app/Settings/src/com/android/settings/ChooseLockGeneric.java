    ...
    public static class ChooseLockGenericFragment extends SettingsPreferenceFragment {
        ...
        private void removeAllFingerprintForUserAndFinish(final int userId) {
            if (this.mFingerprintManager != null && this.mFingerprintManager.isHardwareDetected()) {
                if (this.mFingerprintManager.hasEnrolledFingerprints(userId)) {
                    ...
                    this.mFingerprintManager.remove(finger, userId, new FingerprintManager.RemovalCallback() { // from class: com.android.settings.ChooseLockGeneric.ChooseLockGenericFragment.1
        ...
        public static class FactoryResetProtectionWarningDialog extends DialogFragment {
            ...
            public Dialog onCreateDialog(Bundle savedInstanceState) {
                ...
                return new AlertDialog.Builder(getActivity()).setTitle(args.getInt("titleRes")).setMessage(args.getInt("messageRes")).setPositiveButton(R.string.unlock_disable_frp_warning_ok, new DialogInterface.OnClickListener() { // from class: com.android.settings.ChooseLockGeneric.ChooseLockGenericFragment.FactoryResetProtectionWarningDialog.1
