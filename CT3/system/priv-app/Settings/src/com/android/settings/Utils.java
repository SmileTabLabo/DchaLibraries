...
public final class Utils extends com.android.settingslib.Utils {
    ...
    public static UserHandle getSecureTargetUser(IBinder activityToken, UserManager um, Bundle arguments, Bundle intentExtras) {
        boolean launchedFromSettingsApp;
        ...
        try {
            ...
            launchedFromSettingsApp = "com.android.settings".equals(launchedFromPackage);
            launchedFromUser = new UserHandle(UserHandle.getUserId(am.getLaunchedFromUid(activityToken)));
    ...
    private static void setViewShown(final View view, boolean shown, boolean animate) {
        if (animate) {
            ...
            if (shown) {
                ...
                animation.setAnimationListener(new Animation.AnimationListener() { // from class: com.android.settings.Utils.2
