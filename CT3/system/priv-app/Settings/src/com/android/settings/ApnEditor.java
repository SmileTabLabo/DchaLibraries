...
public class ApnEditor extends SettingsPreferenceFragment implements SharedPreferences.OnSharedPreferenceChangeListener, Preference.OnPreferenceChangeListener, View.OnKeyListener {
    ...
    private final BroadcastReceiver mReceiver = new BroadcastReceiver() { // from class: com.android.settings.ApnEditor.1
    ...
    public void onCreate(Bundle icicle) {
        ...
        this.mSimHotSwapHandler.registerOnSimHotSwap(new SimHotSwapHandler.OnSimHotSwapListener() { // from class: com.android.settings.ApnEditor.2
    ...
    public Dialog onCreateDialog(int id) {
        return id == 1 ? new AlertDialog.Builder(getContext()).setIcon(17301543).setTitle(R.string.error_title).setMessage(getString(R.string.apn_predefine_change_dialog_notice)).setPositiveButton(17039370, new DialogInterface.OnClickListener() { // from class: com.android.settings.ApnEditor.3
    ...
    public static class ErrorDialog extends DialogFragment {
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            return new AlertDialog.Builder(getContext()).setTitle(R.string.error_title).setPositiveButton(17039370, (DialogInterface.OnClickListener) null).setMessage(msg).create();
        }
    }
    ...
    public void updateScreenEnableState() {
        ...
        if (!enable || this.mReadOnlyMode) {
            ...
            z = this.mApnExt.getScreenEnableState(this.mSubId, getActivity());
        }
