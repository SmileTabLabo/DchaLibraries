...
public class SimSettings extends RestrictedSettingsFragment implements Indexable {
        ...
        this.mReceiver = new BroadcastReceiver() { // from class: com.android.settings.sim.SimSettings.3
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                if (action.equals("android.intent.action.AIRPLANE_MODE")) {
                    ...
                    SimSettings.this.updateActivitesCategory();
                } else if (!action.equals("android.intent.action.RADIO_STATE_CHANGED")) {
                } else {
    ...
    public void updateCallValues() {
        ...
        if (defaultAccount == null) {
            ...
            str = (String) defaultAccount.getLabel();
        }
        simPref.setSummary(str);
    ...
    private void initForSimStateChange() {
        ...
        this.mSimHotSwapHandler.registerOnSimHotSwap(new SimHotSwapHandler.OnSimHotSwapListener() { // from class: com.android.settings.sim.SimSettings.5
