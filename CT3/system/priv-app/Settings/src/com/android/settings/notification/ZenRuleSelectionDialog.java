...
public abstract class ZenRuleSelectionDialog {
    ...
    public ZenRuleSelectionDialog(Context context, ZenServiceListing serviceListing) {
        ...
        this.mDialog = new AlertDialog.Builder(context).setTitle(R.string.zen_mode_choose_rule_type).setView(v).setOnDismissListener(new DialogInterface.OnDismissListener() { // from class: com.android.settings.notification.ZenRuleSelectionDialog.3
    ...
    private void bindType(final ZenRuleInfo ri) {
        try {
            ...
            v.setOnClickListener(new View.OnClickListener() { // from class: com.android.settings.notification.ZenRuleSelectionDialog.4
