...
public class PowerUsageSummary extends PowerUsageBase implements Preference.OnPreferenceChangeListener {
    public static final SummaryLoader.SummaryProviderFactory SUMMARY_PROVIDER_FACTORY = new SummaryLoader.SummaryProviderFactory() { // from class: com.android.settings.fuelgauge.PowerUsageSummary.2
    ...
    private static List<BatterySipper> getCoalescedUsageList(List<BatterySipper> sippers) {
        ...
        Collections.sort(results, new Comparator<BatterySipper>() { // from class: com.android.settings.fuelgauge.PowerUsageSummary.3
        ...
        if (averagePower >= 10.0d) {
            ...
            for (int i = 0; i < numSippers; i++) {
                ...
                if (sipper.totalPowerMah * 3600.0d >= 5.0d) {
                    ...
                    double percentOfTotal = (sipper.totalPowerMah / totalPower) * dischargeAmount;
