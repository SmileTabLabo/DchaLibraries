...
public class AppDialogFragment extends DialogFragment implements AppDialog.Listener {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        if (connected && !isUiRestricted()) {
            dlog.setPositiveButton(getActivity().getString(R.string.vpn_disconnect), new DialogInterface.OnClickListener() { // from class: com.android.settings.vpn2.AppDialogFragment.1
