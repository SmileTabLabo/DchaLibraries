...
public final class PhysicalKeyboardFragment extends SettingsPreferenceFragment implements InputManager.InputDeviceListener {
    ...
    public void onCreatePreferences(Bundle bundle, String s) {
        ...
        findPreference("keyboard_shortcuts_helper").setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() { // from class: com.android.settings.inputmethod.PhysicalKeyboardFragment.3
    ...
    public void onLoadFinishedInternal(int loaderId, List<Keyboards> keyboardsList) {
        ...
        for (final Keyboards keyboards : keyboardsList) {
            ...
            for (Keyboards.KeyboardInfo info : keyboards.mKeyboardInfoList) {
                ...
                if (imi != null) {
                    KeyboardInfoPreference pref = new KeyboardInfoPreference(getPrefContext(), info, null);
                    pref.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() { // from class: com.android.settings.inputmethod.PhysicalKeyboardFragment.-void_onLoadFinishedInternal_int_loaderId_java_util_List_keyboardsList_LambdaImpl0
                        @Override // android.support.v7.preference.Preference.OnPreferenceClickListener
    ...
    /* renamed from: -com_android_settings_inputmethod_PhysicalKeyboardFragment_lambda$1  reason: not valid java name */
    /* synthetic */ boolean m955xf9541f50(Keyboards keyboards, InputMethodInfo imi, InputMethodSubtype imSubtype, Preference preference) {
    ...
    public static final class KeyboardInfoPreference extends Preference {
        ...
        /* synthetic */ KeyboardInfoPreference(Context context, Keyboards.KeyboardInfo info, KeyboardInfoPreference keyboardInfoPreference) {
            this(context, info);
        }
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        public static CharSequence getDisplayName(Context context, InputMethodInfo imi, InputMethodSubtype imSubtype) {
