...
public class WirelessSettings extends SettingsPreferenceFragment implements Indexable {
    public static final Indexable.SearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider() { // from class: com.android.settings.WirelessSettings.1
        ...
        public List<String> getNonIndexableKeys(Context context) {
            ...
            boolean isWimaxEnabled = isSecondaryUser ? false : context.getResources().getBoolean(17956969);
            if (!isWimaxEnabled) {
    ...
    private PhoneStateListener mPhoneStateListener = new PhoneStateListener() { // from class: com.android.settings.WirelessSettings.2
    ...
    private final BroadcastReceiver mReceiver = new BroadcastReceiver() { // from class: com.android.settings.WirelessSettings.3
    ...
    public Dialog onCreateDialog(int dialogId) {
        ...
        switch (dialogId) {
            case 1:
                return new AlertDialog.Builder(getActivity()).setMessage(this.mManageMobilePlanMessage).setCancelable(false).setPositiveButton(17039370, new DialogInterface.OnClickListener() { // from class: com.android.settings.WirelessSettings.4
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        boolean isWimaxEnabled = isAdmin ? getResources().getBoolean(17956969) : false;
