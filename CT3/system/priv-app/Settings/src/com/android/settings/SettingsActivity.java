...
public class SettingsActivity extends SettingsDrawerActivity implements PreferenceManager.OnPreferenceTreeClickListener, PreferenceFragment.OnPreferenceStartFragmentCallback, ButtonBarHandler, FragmentManager.OnBackStackChangedListener, SearchView.OnQueryTextListener, SearchView.OnCloseListener, MenuItem.OnActionExpandListener {
    ...
    public void onCreate(Bundle savedState) {
        ...
        backButton.setOnClickListener(new View.OnClickListener() { // from class: com.android.settings.SettingsActivity.3
        ...
        skipButton.setOnClickListener(new View.OnClickListener() { // from class: com.android.settings.SettingsActivity.4
            @Override // android.view.View.OnClickListener
            public void onClick(View v) {
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public void setMainContentId(int contentId) {
    ...
    protected void onStart() {
        ...
        this.mDevelopmentPreferencesListener = new SharedPreferences.OnSharedPreferenceChangeListener() { // from class: com.android.settings.SettingsActivity.6
    ...
    public void updateTilesList() {
        AsyncTask.execute(new Runnable() { // from class: com.android.settings.SettingsActivity.7
    ...
    public void doUpdateTilesList() {
        ...
        setTileEnabled(new ComponentName(packageName, Settings.UserSettingsActivity.class.getName()), UserManager.supportsMultipleUsers() ? !Utils.isMonkeyRunning() : false, isAdmin, pm);
        NfcAdapter nfcAdapter = NfcAdapter.getDefaultAdapter(this);
        int hceFlg = Settings.Global.getInt(getContentResolver(), "nfc_hce_on", 0);
        setTileEnabled(new ComponentName(packageName, Settings.PaymentSettingsActivity.class.getName()), (pm.hasSystemFeature("android.hardware.nfc") && pm.hasSystemFeature("android.hardware.nfc.hce") && nfcAdapter != null && nfcAdapter.isEnabled()) ? hceFlg == 1 : false, isAdmin, pm);
        ...
        boolean showDev = this.mDevelopmentPreferences.getBoolean("show", Build.TYPE.equals("eng")) ? !um.hasUserRestriction("no_debugging_features") : false;
