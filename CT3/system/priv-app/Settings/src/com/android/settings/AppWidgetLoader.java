...
public class AppWidgetLoader<Item extends LabelledItem> {
    ...
    public List<Item> getItems(Intent intent) {
        ...
        Collections.sort(items, new Comparator<Item>() { // from class: com.android.settings.AppWidgetLoader.1
    ...
    void putInstalledAppWidgets(List<Item> items, int categoryFilter) {
        List<AppWidgetProviderInfo> installed = this.mAppWidgetManager.getInstalledProviders(categoryFilter);
