...
public class HomeSettings extends SettingsPreferenceFragment implements Indexable {
    public static final Indexable.SearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider() { // from class: com.android.settings.HomeSettings.3
    ...
    private class HomePackageReceiver extends BroadcastReceiver {
        /* synthetic */ HomePackageReceiver(HomeSettings this$0, HomePackageReceiver homePackageReceiver) {
            this();
        }
    ...
    public void buildHomeActivitiesList() {
        ...
        new Handler().post(new Runnable() { // from class: com.android.settings.HomeSettings.4
