...
public class ZenModeScheduleDaysSelection extends ScrollView {
    ...
    public ZenModeScheduleDaysSelection(Context context, int[] days) {
        ...
        for (int i2 = 0; i2 < DAYS.length; i2++) {
            ...
            checkBox.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: com.android.settings.notification.ZenModeScheduleDaysSelection.1
