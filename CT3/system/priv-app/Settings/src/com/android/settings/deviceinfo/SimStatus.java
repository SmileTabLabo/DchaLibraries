...
public class SimStatus extends SettingsPreferenceFragment {
    ...
    public void onCreate(Bundle icicle) {
        ...
        this.mSimHotSwapHandler.registerOnSimHotSwap(new SimHotSwapHandler.OnSimHotSwapListener() { // from class: com.android.settings.deviceinfo.SimStatus.4
    ...
    public void updatePhoneInfos() {
        ...
        this.mPhoneStateListener = new PhoneStateListener(this.mSir.getSubscriptionId()) { // from class: com.android.settings.deviceinfo.SimStatus.5
