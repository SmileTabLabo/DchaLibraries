...
class WriteWifiConfigToNfcDialog extends AlertDialog implements TextWatcher, View.OnClickListener, CompoundButton.OnCheckedChangeListener {
    ...
    public WriteWifiConfigToNfcDialog(Context context, int networkId, int security, WifiManager wifiManager) {
        super(context);
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public WriteWifiConfigToNfcDialog(Context context, Bundle savedState, WifiManager wifiManager) {
        super(context);
        this.mContext = context;
        this.mWakeLock = ((PowerManager) context.getSystemService("power")).newWakeLock(1, "WriteWifiConfigToNfcDialog:wakeLock");
        this.mOnTextChangedHandler = new Handler();
    ...
    public void onClick(View v) {
        ...
        if (wpsNfcConfigurationToken.contains(String.format("102700%s%s", passwordLength, passwordHex).toUpperCase())) {
            ...
            nfcAdapter.enableReaderMode(activity, new NfcAdapter.ReaderCallback() { // from class: com.android.settings.wifi.WriteWifiConfigToNfcDialog.1
        ...
        if (ndef != null) {
            if (ndef.isWritable()) {
                ...
                try {
                    ...
                    setViewText(this.mCancelButton, 17040788);
    ...
    public void onTextChanged(CharSequence s, int start, int before, int count) {
        this.mOnTextChangedHandler.post(new Runnable() { // from class: com.android.settings.wifi.WriteWifiConfigToNfcDialog.3
            @Override // java.lang.Runnable
            public void run() {
    ...
    private void setViewText(final TextView view, final int resid) {
        getOwnerActivity().runOnUiThread(new Runnable() { // from class: com.android.settings.wifi.WriteWifiConfigToNfcDialog.4
            @Override // java.lang.Runnable
            public void run() {
                view.setText(resid);
            }
