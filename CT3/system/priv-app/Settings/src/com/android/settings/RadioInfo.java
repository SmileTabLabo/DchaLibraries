...
public class RadioInfo extends Activity {
    ...
    private final PhoneStateListener mPhoneStateListener = new PhoneStateListener() { // from class: com.android.settings.RadioInfo.1
    ...
    private MenuItem.OnMenuItemClickListener mViewADNCallback = new MenuItem.OnMenuItemClickListener() { // from class: com.android.settings.RadioInfo.3
    ...
    private MenuItem.OnMenuItemClickListener mViewFDNCallback = new MenuItem.OnMenuItemClickListener() { // from class: com.android.settings.RadioInfo.4
        @Override // android.view.MenuItem.OnMenuItemClickListener
        public boolean onMenuItemClick(MenuItem item) {
            Intent intent = new Intent("android.intent.action.VIEW");
    ...
    private MenuItem.OnMenuItemClickListener mViewSDNCallback = new MenuItem.OnMenuItemClickListener() { // from class: com.android.settings.RadioInfo.5
        @Override // android.view.MenuItem.OnMenuItemClickListener
        public boolean onMenuItemClick(MenuItem item) {
    ...
    private MenuItem.OnMenuItemClickListener mGetPdpList = new MenuItem.OnMenuItemClickListener() { // from class: com.android.settings.RadioInfo.6
        @Override // android.view.MenuItem.OnMenuItemClickListener
        public boolean onMenuItemClick(MenuItem item) {
    ...
    private MenuItem.OnMenuItemClickListener mSelectBandCallback = new MenuItem.OnMenuItemClickListener() { // from class: com.android.settings.RadioInfo.7
        @Override // android.view.MenuItem.OnMenuItemClickListener
        public boolean onMenuItemClick(MenuItem item) {
    ...
    private MenuItem.OnMenuItemClickListener mToggleData = new MenuItem.OnMenuItemClickListener() { // from class: com.android.settings.RadioInfo.8
        @Override // android.view.MenuItem.OnMenuItemClickListener
        public boolean onMenuItemClick(MenuItem item) {
    ...
    CompoundButton.OnCheckedChangeListener mRadioPowerOnChangeListener = new CompoundButton.OnCheckedChangeListener() { // from class: com.android.settings.RadioInfo.9
    ...
    CompoundButton.OnCheckedChangeListener mImsVoLteCheckedChangeListener = new CompoundButton.OnCheckedChangeListener() { // from class: com.android.settings.RadioInfo.10
        @Override // android.widget.CompoundButton.OnCheckedChangeListener
        public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
            RadioInfo.this.setImsVoLteProvisionedState(isChecked);
        }
    };
    View.OnClickListener mDnsCheckButtonHandler = new View.OnClickListener() { // from class: com.android.settings.RadioInfo.11
    ...
    View.OnClickListener mOemInfoButtonHandler = new View.OnClickListener() { // from class: com.android.settings.RadioInfo.12
        @Override // android.view.View.OnClickListener
        public void onClick(View v) {
    ...
    View.OnClickListener mPingButtonHandler = new View.OnClickListener() { // from class: com.android.settings.RadioInfo.13
        @Override // android.view.View.OnClickListener
        public void onClick(View v) {
            RadioInfo.this.updatePingState();
        }
    };
    View.OnClickListener mUpdateSmscButtonHandler = new View.OnClickListener() { // from class: com.android.settings.RadioInfo.14
        @Override // android.view.View.OnClickListener
        public void onClick(View v) {
    ...
    View.OnClickListener mRefreshSmscButtonHandler = new View.OnClickListener() { // from class: com.android.settings.RadioInfo.15
        @Override // android.view.View.OnClickListener
        public void onClick(View v) {
            RadioInfo.this.refreshSmsc();
        }
    };
    AdapterView.OnItemSelectedListener mPreferredNetworkHandler = new AdapterView.OnItemSelectedListener() { // from class: com.android.settings.RadioInfo.16
    ...
    AdapterView.OnItemSelectedListener mCellInfoRefreshRateHandler = new AdapterView.OnItemSelectedListener() { // from class: com.android.settings.RadioInfo.17
        @Override // android.widget.AdapterView.OnItemSelectedListener
        public void onItemSelected(AdapterView parent, View v, int pos, long id) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:12:0x0042 -> B:22:0x0016). Please submit an issue!!! */
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:19:0x0066 -> B:21:0x002c). Please submit an issue!!! */
    ...
    public final void updateAllCellInfo() {
        ...
        final Runnable updateAllCellInfoResults = new Runnable() { // from class: com.android.settings.RadioInfo.18
        ...
        Thread locThread = new Thread() { // from class: com.android.settings.RadioInfo.19
    ...
    public final void updatePingState() {
        ...
        this.mPingHostnameV6.setText(this.mPingHostnameResultV6);
        this.mHttpClientTest.setText(this.mHttpClientTestResult);
        final Runnable updatePingResults = new Runnable() { // from class: com.android.settings.RadioInfo.20
            @Override // java.lang.Runnable
            public void run() {
        ...
        Thread hostname = new Thread() { // from class: com.android.settings.RadioInfo.21
            @Override // java.lang.Thread, java.lang.Runnable
            public void run() {
        ...
        hostname.start();
        Thread httpClient = new Thread() { // from class: com.android.settings.RadioInfo.22
            @Override // java.lang.Thread, java.lang.Runnable
            public void run() {
    ...
    void setImsVoLteProvisionedState(final boolean state) {
        ...
        QueuedWork.singleThreadExecutor().submit(new Runnable() { // from class: com.android.settings.RadioInfo.23
            @Override // java.lang.Runnable
            public void run() {
                try {
