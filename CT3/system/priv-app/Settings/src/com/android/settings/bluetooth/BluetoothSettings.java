...
public final class BluetoothSettings extends DeviceListPreferenceFragment implements Indexable {
    ...
    public static final SummaryLoader.SummaryProviderFactory SUMMARY_PROVIDER_FACTORY = new SummaryLoader.SummaryProviderFactory() { // from class: com.android.settings.bluetooth.BluetoothSettings.3
        @Override // com.android.settings.dashboard.SummaryLoader.SummaryProviderFactory
        public SummaryLoader.SummaryProvider createSummaryProvider(Activity activity, SummaryLoader summaryLoader) {
            return new SummaryProvider(activity, summaryLoader);
        }
    };
    public static final Indexable.SearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider() { // from class: com.android.settings.bluetooth.BluetoothSettings.4
    ...
    private void setOffMessage() {
        ...
        if (!bleScanningMode) {
            ...
            LinkifyUtils.linkify(emptyView, contentBuilder, new LinkifyUtils.OnClickListener() { // from class: com.android.settings.bluetooth.BluetoothSettings.5
