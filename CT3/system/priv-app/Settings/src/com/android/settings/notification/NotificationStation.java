...
public class NotificationStation extends SettingsPreferenceFragment {
    ...
    private final NotificationListenerService mListener = new NotificationListenerService() { // from class: com.android.settings.notification.NotificationStation.2
    ...
    public static class HistoricalNotificationInfo {
        ...
        /* synthetic */ HistoricalNotificationInfo(HistoricalNotificationInfo historicalNotificationInfo) {
            this();
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* loaded from: classes.dex */
    public static class HistoricalNotificationPreference extends CopyablePreference {
        ...
        @Override // com.android.settings.CopyablePreference, android.support.v7.preference.Preference
        public void onBindViewHolder(PreferenceViewHolder row) {
            ...
            row.itemView.setOnClickListener(new View.OnClickListener() { // from class: com.android.settings.notification.NotificationStation.HistoricalNotificationPreference.1
        ...
        @Override // com.android.settings.CopyablePreference
