...
public class WifiSettings extends RestrictedSettingsFragment implements Indexable, WifiTracker.WifiListener, AccessPoint.AccessPointListener, WifiDialog.WifiDialogListener {
    public static final Indexable.SearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider() { // from class: com.android.settings.wifi.WifiSettings.1
    ...
    public static final SummaryLoader.SummaryProviderFactory SUMMARY_PROVIDER_FACTORY = new SummaryLoader.SummaryProviderFactory() { // from class: com.android.settings.wifi.WifiSettings.2
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        this.mConnectListener = new WifiManager.ActionListener() { // from class: com.android.settings.wifi.WifiSettings.4
        ...
        this.mSaveListener = new WifiManager.ActionListener() { // from class: com.android.settings.wifi.WifiSettings.5
            public void onSuccess() {
        ...
        this.mForgetListener = new WifiManager.ActionListener() { // from class: com.android.settings.wifi.WifiSettings.6
            public void onSuccess() {
                WifiSettings.this.mWifiSettingsExt.updatePriority();
            }
        ...
        switch (wifiState) {
            ...
            case 3:
                ...
                if (!hasAvailableAccessPoints) {
                    setProgressBarVisible(true);
                    Preference pref2 = new Preference(getContext()) { // from class: com.android.settings.wifi.WifiSettings.7
    ...
    private void setOffMessage() {
        ...
        if (!wifiScanningMode) {
            ...
            LinkifyUtils.linkify(emptyTextView, contentBuilder, new LinkifyUtils.OnClickListener() { // from class: com.android.settings.wifi.WifiSettings.8
        ...
        boldSpan.setSpan(new TextAppearanceSpan(getActivity(), 16973892), 0, briefText.length(), 33);
        this.mWifiSettingsExt.emptyScreen(getPreferenceScreen());
    }
