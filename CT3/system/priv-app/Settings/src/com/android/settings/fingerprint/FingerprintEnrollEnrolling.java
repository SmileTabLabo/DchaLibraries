...
public class FingerprintEnrollEnrolling extends FingerprintEnrollBase implements FingerprintEnrollSidecar.Listener {
    ...
    private final Animator.AnimatorListener mProgressAnimationListener = new Animator.AnimatorListener() { // from class: com.android.settings.fingerprint.FingerprintEnrollEnrolling.1
    ...
    private final Runnable mDelayedFinishRunnable = new Runnable() { // from class: com.android.settings.fingerprint.FingerprintEnrollEnrolling.2
        @Override // java.lang.Runnable
        public void run() {
            FingerprintEnrollEnrolling.this.launchFinish(FingerprintEnrollEnrolling.this.mToken);
        }
    };
    private final Animatable2.AnimationCallback mIconAnimationCallback = new Animatable2.AnimationCallback() { // from class: com.android.settings.fingerprint.FingerprintEnrollEnrolling.3
        @Override // android.graphics.drawable.Animatable2.AnimationCallback
        public void onAnimationEnd(Drawable d) {
            if (FingerprintEnrollEnrolling.this.mAnimationCancelled) {
                return;
            }
            FingerprintEnrollEnrolling.this.mFingerprintAnimator.post(new Runnable() { // from class: com.android.settings.fingerprint.FingerprintEnrollEnrolling.3.1
                @Override // java.lang.Runnable
                public void run() {
    ...
    private final Runnable mShowDialogRunnable = new Runnable() { // from class: com.android.settings.fingerprint.FingerprintEnrollEnrolling.4
        @Override // java.lang.Runnable
        public void run() {
            FingerprintEnrollEnrolling.this.showIconTouchDialog();
        }
    };
    private final Runnable mTouchAgainRunnable = new Runnable() { // from class: com.android.settings.fingerprint.FingerprintEnrollEnrolling.5
        @Override // java.lang.Runnable
        public void run() {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.mFingerprintAnimator.setOnTouchListener(new View.OnTouchListener() { // from class: com.android.settings.fingerprint.FingerprintEnrollEnrolling.6
    ...
    private void animateFlash() {
        ...
        final ValueAnimator.AnimatorUpdateListener listener = new ValueAnimator.AnimatorUpdateListener() { // from class: com.android.settings.fingerprint.FingerprintEnrollEnrolling.7
        ...
        anim.addListener(new AnimatorListenerAdapter() { // from class: com.android.settings.fingerprint.FingerprintEnrollEnrolling.8
    ...
    private void clearError() {
        if (this.mErrorText.getVisibility() == 0) {
            this.mErrorText.animate().alpha(0.0f).translationY(getResources().getDimensionPixelSize(R.dimen.fingerprint_error_text_disappear_distance)).setDuration(100L).setInterpolator(this.mFastOutLinearInInterpolator).withEndAction(new Runnable() { // from class: com.android.settings.fingerprint.FingerprintEnrollEnrolling.9
                @Override // java.lang.Runnable
                public void run() {
