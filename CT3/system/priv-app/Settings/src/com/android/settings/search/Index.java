...
public class Index {
    ...
    public void addSavedQuery(String query) {
        SaveSearchQueryTask task = new SaveSearchQueryTask(this, null);
        task.execute(query);
    }

    public void update() {
        AsyncTask.execute(new Runnable() { // from class: com.android.settings.search.Index.1
            @Override // java.lang.Runnable
            public void run() {
                Intent intent = new Intent("android.content.action.SEARCH_INDEXABLES_PROVIDER");
                List<ResolveInfo> list = Index.this.mContext.getPackageManager().queryIntentContentProviders(intent, 0);
                int size = list.size();
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public boolean addIndexablesFromRemoteProvider(String packageName, String authority) {
        try {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void addNonIndexablesKeysFromRemoteProvider(String packageName, String authority) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public boolean isWellKnownProvider(ResolveInfo info) {
        String authority = info.providerInfo.authority;
    ...
    private boolean isPrivilegedPackage(String packageName) {
        ...
        try {
            ...
            return (packInfo.applicationInfo.privateFlags & 8) != 0;
        } catch (PackageManager.NameNotFoundException e) {
            return false;
        }
    }
    ...
    public void updateFromClassNameResource(String className, final boolean rebuild, boolean includeInSearchResults) {
        ...
        AsyncTask.execute(new Runnable() { // from class: com.android.settings.search.Index.2
            @Override // java.lang.Runnable
            public void run() {
                if (rebuild) {
    ...
    public void updateFromSearchIndexableData(final SearchIndexableData data) {
        AsyncTask.execute(new Runnable() { // from class: com.android.settings.search.Index.3
            @Override // java.lang.Runnable
            public void run() {
    ...
    public void updateInternal() {
        synchronized (this.mDataToProcess) {
            UpdateIndexTask task = new UpdateIndexTask(this, null);
    ...
    private void updateOneRowWithFilteredData(SQLiteDatabase database, String locale, String title, String summaryOn, String summaryOff, String entries, String className, String screenTitle, int iconResId, int rank, String keywords, String intentAction, String intentTargetPackage, String intentTargetClass, boolean enabled, String key, int userId) {
        ...
        String spaceDelimitedKeywords = normalizeKeywords(keywords);
        updateOneRow(database, locale, updatedTitle, normalizedTitle, updatedSummaryOn, normalizedSummaryOn, updatedSummaryOff, normalizedSummaryOff, entries, className, screenTitle, iconResId, rank, spaceDelimitedKeywords, intentAction, intentTargetPackage, intentTargetClass, enabled, key, userId);
    }
    ...
    public class UpdateIndexTask extends AsyncTask<UpdateData, Integer, Void> {
        /* synthetic */ UpdateIndexTask(Index this$0, UpdateIndexTask updateIndexTask) {
            this();
        }
        ...
        public void onPostExecute(Void aVoid) {
            super.onPostExecute((UpdateIndexTask) aVoid);
        ...
        public Void doInBackground(UpdateData... params) {
            List<SearchIndexableData> dataToUpdate;
            ...
            try {
                dataToUpdate = params[0].dataToUpdate;
                dataToDelete = params[0].dataToDelete;
                nonIndexableKeys = params[0].nonIndexableKeys;
                forceUpdate = params[0].forceUpdate;
                fullIndex = params[0].fullIndex;
                database = Index.this.getWritableDatabase();
            } catch (SQLiteFullException e) {
                Log.e("Index", "Unable to index search, out of space", e);
            }
            if (database == null) {
            ...
            if (fullIndex) {
                IndexDatabaseHelper.setLocaleIndexed(Index.this.mContext, localeStr);
            }
            return null;
        }
        ...
        private boolean processDataToUpdate(SQLiteDatabase database, String localeStr, List<SearchIndexableData> dataToUpdate, Map<String, List<String>> nonIndexableKeys, boolean forceUpdate) {
            if (!forceUpdate && IndexDatabaseHelper.isLocaleAlreadyIndexed(Index.this.mContext, localeStr)) {
            ...
            for (int n = 0; n < count; n++) {
                String str = (SearchIndexableData) dataToUpdate.get(n);
                try {
                    Index.this.indexOneSearchIndexableData(database, localeStr, str, nonIndexableKeys);
                } catch (Exception e) {
                    StringBuilder append = new StringBuilder().append("Cannot index: ");
                    if (str != null) {
                        str = ((SearchIndexableData) str).className;
                    }
                    Log.e("Index", append.append((Object) str).append(" for locale: ").append(localeStr).toString(), e);
                }
            }
    ...
    private class SaveSearchQueryTask extends AsyncTask<String, Void, Long> {
        /* synthetic */ SaveSearchQueryTask(Index this$0, SaveSearchQueryTask saveSearchQueryTask) {
            this();
        }
