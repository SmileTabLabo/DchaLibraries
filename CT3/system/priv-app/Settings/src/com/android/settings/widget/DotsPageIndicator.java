...
public class DotsPageIndicator extends View implements ViewPager.OnPageChangeListener {
    ...
    private void setSelectedPage(int now) {
        ...
        if (Build.VERSION.SDK_INT >= 16) {
            ...
            for (int i = 0; i < steps; i++) {
                this.joiningAnimations[i] = createJoiningAnimator(now > was ? was + i : (was - 1) - i, i * (this.animDuration / 8));
            }
    ...
    private ValueAnimator createMoveSelectedAnimator(float moveTo, int was, int now, int steps) {
        ...
        moveSelected.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.android.settings.widget.DotsPageIndicator.3
        ...
        moveSelected.addListener(new AnimatorListenerAdapter() { // from class: com.android.settings.widget.DotsPageIndicator.4
    ...
    private ValueAnimator createJoiningAnimator(final int leftJoiningDot, long startDelay) {
        ...
        joining.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.android.settings.widget.DotsPageIndicator.5
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
    ...
    private void cancelRevealAnimations() {
        PendingRevealAnimator[] pendingRevealAnimatorArr;
        ...
        public PendingRetreatAnimator(int was, int now, int steps, StartPredicate predicate) {
            ...
            if (initialX1 != finalX1) {
                ...
                for (int i2 = 0; i2 < steps; i2++) {
                    DotsPageIndicator.this.revealAnimations[i2] = new PendingRevealAnimator(was - i2, new LeftwardStartPredicate(DotsPageIndicator.this.dotCenterX[was - i2]));
