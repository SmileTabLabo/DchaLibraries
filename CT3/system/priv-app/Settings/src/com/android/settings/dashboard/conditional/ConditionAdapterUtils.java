...
public class ConditionAdapterUtils {
    public static void addDismiss(final RecyclerView recyclerView) {
        ItemTouchHelper.SimpleCallback callback = new ItemTouchHelper.SimpleCallback(0, 48) { // from class: com.android.settings.dashboard.conditional.ConditionAdapterUtils.1
            ...
            if (actions.length > i) {
                ...
                button.setOnClickListener(new View.OnClickListener() { // from class: com.android.settings.dashboard.conditional.ConditionAdapterUtils.2
                    ...
                    public void onClick(View v) {
                        MetricsLogger.action(v.getContext(), 376, Condition.this.getMetricsConstant());
                        Condition.this.onActionClick(index);
                    }
                });
            } else {
    ...
    private static void animateChange(View view, final View content, final View detailGroup, final boolean visible, boolean hasButtons) {
        ...
        view.addOnLayoutChangeListener(new View.OnLayoutChangeListener() { // from class: com.android.settings.dashboard.conditional.ConditionAdapterUtils.3
            ...
            public void onLayoutChange(View v, int left, int top, int right, int bottom, int oldLeft, int oldTop, int oldRight, int oldBottom) {
                ...
                animator.addListener(new AnimatorListenerAdapter() { // from class: com.android.settings.dashboard.conditional.ConditionAdapterUtils.3.1
