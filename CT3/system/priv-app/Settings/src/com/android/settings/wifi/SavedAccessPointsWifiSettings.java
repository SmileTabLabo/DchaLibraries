...
public class SavedAccessPointsWifiSettings extends SettingsPreferenceFragment implements Indexable, WifiDialog.WifiDialogListener {
    public static final Indexable.SearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider() { // from class: com.android.settings.wifi.SavedAccessPointsWifiSettings.1
    ...
    private void initPreferences() {
        ...
        List<AccessPoint> accessPoints = WifiTracker.getCurrentAccessPoints(context, true, false, true);
        Collections.sort(accessPoints, new Comparator<AccessPoint>() { // from class: com.android.settings.wifi.SavedAccessPointsWifiSettings.2
