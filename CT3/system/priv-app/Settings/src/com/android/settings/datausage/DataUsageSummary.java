...
public class DataUsageSummary extends DataUsageBase implements Indexable {
    ...
    public void onCreate(Bundle icicle) {
        ...
        this.mSimHotSwapHandler.registerOnSimHotSwap(new SimHotSwapHandler.OnSimHotSwapListener() { // from class: com.android.settings.datausage.DataUsageSummary.3
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.data_usage_menu_cellular_data_control /* 2131886874 */:
                ...
                return true;
            case R.id.data_usage_menu_cellular_networks /* 2131886875 */:
    ...
    private static CharSequence formatTitle(Context context, String template, long usageLevel) {
        SpannableString amountTemplate = new SpannableString(context.getString(17039503).replace("%1$s", "^1").replace("%2$s", "^2"));
