...
public class AccountSettings extends SettingsPreferenceFragment implements AuthenticatorHelper.OnAccountsUpdateListener, Preference.OnPreferenceClickListener, Indexable {
    ...
    public boolean onPreferenceClick(Preference preference) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (preference == profileData.addAccountPreference) {
                ...
                UserDialogs.createRemoveDialog(getActivity(), userId, new DialogInterface.OnClickListener() { // from class: com.android.settings.accounts.AccountSettings.2
    ...
    private ArrayList<AccountPreference> getAccountTypePreferences(AuthenticatorHelper helper, UserHandle userHandle) {
        ...
        for (String accountType : accountTypes) {
            if (accountTypeHasAnyRequestedAuthorities(helper, accountType) && (label = helper.getLabelForType(getActivity(), accountType)) != null) {
                ...
                if (accounts.length != 1) {
                    ...
                    skipToAccount = !helper.hasAccountPreferences(accountType);
                }
                if (skipToAccount) {
        ...
        Collections.sort(accountTypePreferences, new Comparator<AccountPreference>() { // from class: com.android.settings.accounts.AccountSettings.3
    ...
    private class ManagedProfileBroadcastReceiver extends BroadcastReceiver {
        ...
        /* synthetic */ ManagedProfileBroadcastReceiver(AccountSettings this$0, ManagedProfileBroadcastReceiver managedProfileBroadcastReceiver) {
            this();
        }
    ...
    public static class ConfirmAutoSyncChangeFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(17039370, new DialogInterface.OnClickListener() { // from class: com.android.settings.accounts.AccountSettings.ConfirmAutoSyncChangeFragment.1
                @Override // android.content.DialogInterface.OnClickListener
                public void onClick(DialogInterface dialog, int which) {
