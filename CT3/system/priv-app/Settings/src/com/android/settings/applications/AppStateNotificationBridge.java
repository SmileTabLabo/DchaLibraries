...
public class AppStateNotificationBridge extends AppStateBaseBridge {
    ...
    public static final ApplicationsState.AppFilter FILTER_APP_NOTIFICATION_SILENCED = new ApplicationsState.AppFilter() { // from class: com.android.settings.applications.AppStateNotificationBridge.2
        @Override // com.android.settingslib.applications.ApplicationsState.AppFilter
        public void init() {
        }
    ...
    public static final ApplicationsState.AppFilter FILTER_APP_NOTIFICATION_PRIORITY = new ApplicationsState.AppFilter() { // from class: com.android.settings.applications.AppStateNotificationBridge.3
        @Override // com.android.settingslib.applications.ApplicationsState.AppFilter
        public void init() {
        }
    ...
    public static final ApplicationsState.AppFilter FILTER_APP_NOTIFICATION_HIDE_SENSITIVE = new ApplicationsState.AppFilter() { // from class: com.android.settings.applications.AppStateNotificationBridge.4
        @Override // com.android.settingslib.applications.ApplicationsState.AppFilter
        public void init() {
        }
    ...
    public static final ApplicationsState.AppFilter FILTER_APP_NOTIFICATION_HIDE_ALL = new ApplicationsState.AppFilter() { // from class: com.android.settings.applications.AppStateNotificationBridge.5
        @Override // com.android.settingslib.applications.ApplicationsState.AppFilter
        public void init() {
        }
