...
public class DevelopmentSettings extends RestrictedSettingsFragment implements DialogInterface.OnClickListener, DialogInterface.OnDismissListener, Preference.OnPreferenceChangeListener, SwitchBar.OnSwitchChangeListener, Indexable {
    ...
    public static final Indexable.SearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider() { // from class: com.android.settings.DevelopmentSettings.2
        ...
        public List<String> getNonIndexableKeys(Context context) {
            ...
            if (!DevelopmentSettings.m360wrap0()) {
    ...
    static /* synthetic */ boolean m360wrap0() {
    ...
    public DevelopmentSettings() {
        ...
        this.mUsbReceiver = new BroadcastReceiver() { // from class: com.android.settings.DevelopmentSettings.1
    ...
    public void onCreate(Bundle icicle) {
        ...
        if (BenesseExtension.getDchaState() != 3 && BenesseExtension.COUNT_DCHA_COMPLETED_FILE.exists() && getUid(BenesseExtension.IGNORE_DCHA_COMPLETED_FILE) != 0) {
            ...
            this.mDialog = new AlertDialog.Builder(getActivity()).setTitle(R.string.unlock_set_unlock_password_title).setView(this.mEditText).setPositiveButton(R.string.dlg_ok, new DialogInterface.OnClickListener() { // from class: com.android.settings.DevelopmentSettings.-void_onCreate_android_os_Bundle_icicle_LambdaImpl0
                @Override // android.content.DialogInterface.OnClickListener
                public void onClick(DialogInterface arg0, int arg1) {
                    DevelopmentSettings.this.m363com_android_settings_DevelopmentSettings_lambda$1(arg0, arg1);
                }
            }).setNegativeButton(R.string.dlg_cancel, new DialogInterface.OnClickListener() { // from class: com.android.settings.DevelopmentSettings.-void_onCreate_android_os_Bundle_icicle_LambdaImpl1
                @Override // android.content.DialogInterface.OnClickListener
                public void onClick(DialogInterface arg0, int arg1) {
                    DevelopmentSettings.this.m364com_android_settings_DevelopmentSettings_lambda$2(arg0, arg1);
                }
            }).setOnCancelListener(new DialogInterface.OnCancelListener() { // from class: com.android.settings.DevelopmentSettings.-void_onCreate_android_os_Bundle_icicle_LambdaImpl2
    ...
    /* renamed from: -com_android_settings_DevelopmentSettings_lambda$1  reason: not valid java name */
    /* synthetic */ void m363com_android_settings_DevelopmentSettings_lambda$1(DialogInterface dialog, int which) {
    ...
    /* renamed from: -com_android_settings_DevelopmentSettings_lambda$2  reason: not valid java name */
    /* synthetic */ void m364com_android_settings_DevelopmentSettings_lambda$2(DialogInterface dialog, int which) {
        getActivity().finish();
    }

    /* renamed from: -com_android_settings_DevelopmentSettings_lambda$3  reason: not valid java name */
    /* synthetic */ void m365com_android_settings_DevelopmentSettings_lambda$3(DialogInterface dialog) {
        getActivity().finish();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        this.mFrameLayout = (FrameLayout) root.findViewById(16908351);
        this.mView = new View(getActivity());
        this.mView.setBackgroundColor(-16777216);
        this.mView.setOnTouchListener(new View.OnTouchListener() { // from class: com.android.settings.DevelopmentSettings.3
    ...
    public void updateAllOptions() {
        ...
        if (this.mAdbDialog == null || !this.mAdbDialog.isShowing()) {
            isChecked = Settings.Global.getInt(cr, "adb_enabled", 0) != 0;
        } else {
            isChecked = true;
        }
    ...
    private void writeColorTemperature() {
        ...
        pokeSystemProperties();
        Toast.makeText(getActivity(), (int) R.string.color_temperature_toast, 1).show();
    }
    ...
    private void writeLogdSizeOption(Object newValue) {
        String snetValue;
        boolean equals = newValue != null ? newValue.toString().equals("32768") : false;
        String currentTag = SystemProperties.get("persist.log.tag");
        if (currentTag == null) {
            currentTag = "";
        }
    ...
    public void updateUsbConfigurationValues() {
        ...
        while (true) {
            if (i >= titles.length) {
                break;
            } else if (!manager.isFunctionEnabled(values[i])) {
                i++;
            } else {
                index = i;
                break;
    ...
    private void confirmEnableOemUnlock() {
        DialogInterface.OnClickListener onClickListener = new DialogInterface.OnClickListener() { // from class: com.android.settings.DevelopmentSettings.4
            @Override // android.content.DialogInterface.OnClickListener
        ...
        DialogInterface.OnDismissListener onDismissListener = new DialogInterface.OnDismissListener() { // from class: com.android.settings.DevelopmentSettings.5
        ...
        new AlertDialog.Builder(getActivity()).setTitle(R.string.confirm_enable_oem_unlock_title).setMessage(R.string.confirm_enable_oem_unlock_text).setPositiveButton(R.string.enable_text, onClickListener).setNegativeButton(17039360, (DialogInterface.OnClickListener) null).setOnDismissListener(onDismissListener).create().show();
    }
    ...
    public void onSwitchChanged(Switch switchView, boolean isChecked) {
        if (switchView == this.mSwitchBar.getSwitch() && isChecked != this.mLastEnabledState) {
            ...
            this.mEnableDialog = new AlertDialog.Builder(getActivity()).setMessage(getActivity().getResources().getString(R.string.dev_settings_warning_message)).setTitle(R.string.dev_settings_warning_title).setPositiveButton(17039379, this).setNegativeButton(17039369, this).show();
    ...
    public boolean onPreferenceTreeClick(Preference preference) {
        ...
        if (preference == this.mEnableAdb) {
            if (this.mEnableAdb.isChecked()) {
                ...
                this.mAdbDialog = new AlertDialog.Builder(getActivity()).setMessage(getActivity().getResources().getString(R.string.adb_warning_message)).setTitle(R.string.adb_warning_title).setPositiveButton(17039379, this).setNegativeButton(17039369, this).show();
            ...
            this.mAdbKeysDialog = new AlertDialog.Builder(getActivity()).setMessage(R.string.adb_keys_warning_message).setPositiveButton(17039370, this).setNegativeButton(17039360, (DialogInterface.OnClickListener) null).show();
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if ("hdcp_checking".equals(preference.getKey())) {
            ...
            if (newValue == null) {
                ...
                Toast toast = Toast.makeText(getActivity(), (int) R.string.select_webview_provider_toast_text, 0);
                toast.show();
                return false;
            }
    ...
    private void confirmResetShortcutManagerThrottling() {
        ...
        DialogInterface.OnClickListener onClickListener = new DialogInterface.OnClickListener() { // from class: com.android.settings.DevelopmentSettings.6
            @Override // android.content.DialogInterface.OnClickListener
            public void onClick(DialogInterface dialog, int which) {
                if (which != -1) {
                    return;
        ...
        new AlertDialog.Builder(getActivity()).setTitle(R.string.confirm_reset_shortcut_manager_throttling_title).setMessage(R.string.confirm_reset_shortcut_manager_throttling_message).setPositiveButton(R.string.okay, onClickListener).setNegativeButton(17039360, (DialogInterface.OnClickListener) null).create().show();
    }
