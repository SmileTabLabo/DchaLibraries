...
public final class WifiDisplaySettings extends SettingsPreferenceFragment {
    ...
    private final Runnable mUpdateRunnable = new Runnable() { // from class: com.android.settings.wfd.WifiDisplaySettings.1
    ...
    private final BroadcastReceiver mReceiver = new BroadcastReceiver() { // from class: com.android.settings.wfd.WifiDisplaySettings.2
    ...
    private final ContentObserver mSettingsObserver = new ContentObserver(new Handler()) { // from class: com.android.settings.wfd.WifiDisplaySettings.3
        @Override // android.database.ContentObserver
        public void onChange(boolean selfChange, Uri uri) {
            WifiDisplaySettings.this.scheduleUpdate(1);
        }
    };
    private final MediaRouter.Callback mRouterCallback = new MediaRouter.SimpleCallback() { // from class: com.android.settings.wfd.WifiDisplaySettings.4
    ...
    public void update(int changes) {
        ...
        if (this.mExt != null) {
            ...
            if (this.mWifiDisplayStatus == null) {
                ...
                z = this.mWifiDisplayStatus.getFeatureState() == 3;
            }
    ...
    private void buildCertificationMenu(PreferenceScreen preferenceScreen) {
        ...
        if (!this.mWifiDisplayStatus.getSessionInfo().getGroupId().isEmpty()) {
            ...
            if (this.mWifiDisplayStatus.getSessionInfo().getSessionId() != 0) {
                Preference bf = new Preference(getPrefContext()) { // from class: com.android.settings.wfd.WifiDisplaySettings.5
                    @Override // android.support.v7.preference.Preference
                    public void onBindViewHolder(PreferenceViewHolder view) {
                        super.onBindViewHolder(view);
                        Button b = (Button) view.findViewById(R.id.left_button);
                        b.setText(R.string.wifi_display_pause);
                        b.setOnClickListener(new View.OnClickListener() { // from class: com.android.settings.wfd.WifiDisplaySettings.5.1
                        ...
                        b2.setOnClickListener(new View.OnClickListener() { // from class: com.android.settings.wfd.WifiDisplaySettings.5.2
                            @Override // android.view.View.OnClickListener
                            public void onClick(View v) {
        ...
        SwitchPreference pref = new SwitchPreference(getPrefContext()) { // from class: com.android.settings.wfd.WifiDisplaySettings.6
        ...
        SwitchPreference pref2 = new SwitchPreference(getPrefContext()) { // from class: com.android.settings.wfd.WifiDisplaySettings.7
            /* JADX INFO: Access modifiers changed from: protected */
            @Override // android.support.v7.preference.TwoStatePreference, android.support.v7.preference.Preference
            public void onClick() {
        ...
        lp.setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() { // from class: com.android.settings.wfd.WifiDisplaySettings.8
        ...
        lp2.setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() { // from class: com.android.settings.wfd.WifiDisplaySettings.9
            @Override // android.support.v7.preference.Preference.OnPreferenceChangeListener
            public boolean onPreferenceChange(Preference preference, Object value) {
        ...
        lp3.setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() { // from class: com.android.settings.wfd.WifiDisplaySettings.10
            @Override // android.support.v7.preference.Preference.OnPreferenceChangeListener
            public boolean onPreferenceChange(Preference preference, Object value) {
                int channel = Integer.parseInt((String) value);
    ...
    public void startAutoGO() {
        this.mWifiP2pManager.createGroup(this.mWifiP2pChannel, new WifiP2pManager.ActionListener() { // from class: com.android.settings.wfd.WifiDisplaySettings.11
    ...
    public void stopAutoGO() {
        this.mWifiP2pManager.removeGroup(this.mWifiP2pChannel, new WifiP2pManager.ActionListener() { // from class: com.android.settings.wfd.WifiDisplaySettings.12
            @Override // android.net.wifi.p2p.WifiP2pManager.ActionListener
            public void onSuccess() {
            }
    ...
    public void setListenMode(final boolean enable) {
        this.mWifiP2pManager.listen(this.mWifiP2pChannel, enable, new WifiP2pManager.ActionListener() { // from class: com.android.settings.wfd.WifiDisplaySettings.13
            @Override // android.net.wifi.p2p.WifiP2pManager.ActionListener
            public void onSuccess() {
            }
    ...
    public void setWifiP2pChannels(int lc, int oc) {
        this.mWifiP2pManager.setWifiP2pChannels(this.mWifiP2pChannel, lc, oc, new WifiP2pManager.ActionListener() { // from class: com.android.settings.wfd.WifiDisplaySettings.14
            @Override // android.net.wifi.p2p.WifiP2pManager.ActionListener
            public void onSuccess() {
            }
    ...
    public void showWifiDisplayOptionsDialog(final WifiDisplay display) {
        ...
        DialogInterface.OnClickListener done = new DialogInterface.OnClickListener() { // from class: com.android.settings.wfd.WifiDisplaySettings.15
            @Override // android.content.DialogInterface.OnClickListener
            public void onClick(DialogInterface dialog, int which) {
                String name = nameEditText.getText().toString().trim();
                name = (name.isEmpty() || name.equals(display.getDeviceName())) ? null : null;
                WifiDisplaySettings.this.mDisplayManager.renameWifiDisplay(display.getDeviceAddress(), name);
            }
        };
        DialogInterface.OnClickListener forget = new DialogInterface.OnClickListener() { // from class: com.android.settings.wfd.WifiDisplaySettings.16
            @Override // android.content.DialogInterface.OnClickListener
            public void onClick(DialogInterface dialog, int which) {
