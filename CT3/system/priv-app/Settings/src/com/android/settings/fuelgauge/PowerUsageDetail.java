...
public class PowerUsageDetail extends PowerUsageBase implements View.OnClickListener {
    ...
    private static final /* synthetic */ int[] f8comandroidinternalosBatterySipper$DrainTypeSwitchesValues = null;
    ...
    private static /* synthetic */ int[] m940xe0235176() {
    ...
    public static void startBatteryDetailPage(SettingsActivity caller, BatteryStatsHelper helper, int statsType, BatteryEntry entry, boolean showLocationButton, boolean includeAppInfo) {
        ...
        args.putInt("percent", (int) (((entry.sipper.totalPowerMah * dischargeAmount) / helper.getTotalPower()) + 0.5d));
    ...
    @Override // com.android.settings.fuelgauge.PowerUsageBase, com.android.settings.SettingsPreferenceFragment, android.support.v14.preference.PreferenceFragment, android.app.Fragment
    ...
    private void createDetails() {
        ...
        if (this.mUid >= 10000) {
            ...
            this.mReportButton.setText(17040283);
    ...
    private void setupHeader() {
        ...
        AppHeader.createAppHeader(this, appIcon, title, pkg, uid, this.mDrainType != BatterySipper.DrainType.APP ? 17170443 : 0);
    }
        ...
        for (int i = 0; i < this.mTypes.length; i++) {
            if (this.mValues[i] > 0.0d) {
                ...
                switch (this.mTypes[i]) {
                    case R.string.usage_type_gps /* 2131429308 */:
                        this.mUsesGps = true;
                    case R.string.usage_type_wifi_running /* 2131429309 */:
                    case R.string.usage_type_phone /* 2131429310 */:
                    case R.string.usage_type_radio_active /* 2131429313 */:
                    case R.string.usage_type_audio /* 2131429316 */:
                    case R.string.usage_type_video /* 2131429317 */:
                    case R.string.usage_type_camera /* 2131429318 */:
                    case R.string.usage_type_flashlight /* 2131429319 */:
                    case R.string.usage_type_on_time /* 2131429320 */:
                    default:
                        value = Utils.formatElapsedTime(getActivity(), this.mValues[i], true);
                        break;
                    case R.string.usage_type_data_send /* 2131429311 */:
                    case R.string.usage_type_data_recv /* 2131429312 */:
                    case R.string.usage_type_data_wifi_send /* 2131429314 */:
                    case R.string.usage_type_data_wifi_recv /* 2131429315 */:
                        long packets = (long) this.mValues[i];
                        value = Long.toString(packets);
                        break;
                    case R.string.usage_type_no_coverage /* 2131429321 */:
                        int percentage = (int) Math.floor(this.mValues[i]);
                        value = Utils.formatPercentage(percentage);
                        break;
                    case R.string.usage_type_total_battery_capacity /* 2131429322 */:
                    case R.string.usage_type_computed_power /* 2131429323 */:
                    case R.string.usage_type_actual_power /* 2131429324 */:
    ...
    private void addControl(int pageSummary, int actionTitle, final int action) {
        ...
        pref.setLayoutResource(R.layout.horizontal_preference);
        pref.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() { // from class: com.android.settings.fuelgauge.PowerUsageDetail.3
            @Override // android.support.v7.preference.Preference.OnPreferenceClickListener
            public boolean onPreferenceClick(Preference preference) {
    ...
    private void checkForceStop() {
        ...
        for (int i2 = 0; i2 < this.mPackages.length; i2++) {
            try {
                info = this.mPm.getApplicationInfo(this.mPackages[i2], 0);
            } catch (PackageManager.NameNotFoundException e) {
            }
