...
public abstract class ZenRuleNameDialog {
    ...
    public ZenRuleNameDialog(Context context, CharSequence ruleName) {
        ...
        this.mDialog = new AlertDialog.Builder(context).setTitle(this.mIsNew ? R.string.zen_mode_add_rule : R.string.zen_mode_rule_name).setView(v).setPositiveButton(R.string.okay, new DialogInterface.OnClickListener() { // from class: com.android.settings.notification.ZenRuleNameDialog.1
