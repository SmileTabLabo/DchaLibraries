...
public class ChartDataUsageView extends ChartView {
    ...
    public ChartDataUsageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        this.mVertListener = new ChartSweepView.OnSweepListener() { // from class: com.android.settings.widget.ChartDataUsageView.1
        ...
        this.mHandler = new Handler() { // from class: com.android.settings.widget.ChartDataUsageView.2
    ...
    public static class TimeAxis implements ChartAxis {
        ...
        public long convertToValue(float point) {
            return ((float) this.mMin) + ((((float) (this.mMax - this.mMin)) * point) / this.mSize);
        }
    ...
    public static class DataAxis implements ChartAxis {
        ...
        public int shouldAdjustAxis(long value) {
            ...
            if (point < this.mSize * 0.1d) {
                return -1;
            }
            if (point > this.mSize * 0.85d) {
                return 1;
            }
            return 0;
        }
