...
public class ZenModePrioritySettings extends ZenModeSettingsBase implements Indexable {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        this.mRepeatCallers.setSummary(this.mContext.getString(R.string.zen_mode_repeat_callers_summary, Integer.valueOf(this.mContext.getResources().getInteger(17694866))));
    ...
    private void updateControls() {
        ...
        if (isPriorityCategoryEnabled(8)) {
            z = this.mPolicy.priorityCallSenders != 0;
        } else {
            z = true;
        }
