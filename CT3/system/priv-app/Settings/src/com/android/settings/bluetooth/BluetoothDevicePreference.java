...
public final class BluetoothDevicePreference extends Preference implements CachedBluetoothDevice.Callback, View.OnClickListener {
    ...
    private void askDisconnect() {
        ...
        DialogInterface.OnClickListener disconnectListener = new DialogInterface.OnClickListener() { // from class: com.android.settings.bluetooth.BluetoothDevicePreference.1
    ...
    private Pair<Integer, String> getBtClassDrawableWithDescription() {
        ...
        if (btClass != null) {
            switch (btClass.getMajorDeviceClass()) {
                case 256:
                    return new Pair<>(Integer.valueOf((int) R.drawable.ic_bt_laptop), this.COMPUTER);
                case 512:
                    return new Pair<>(Integer.valueOf((int) R.drawable.ic_bt_cellphone), this.PHONE);
                case 1280:
                    return new Pair<>(Integer.valueOf(HidProfile.getHidClassDrawable(btClass)), this.INPUT_PERIPHERAL);
                case 1536:
                    return new Pair<>(Integer.valueOf((int) R.drawable.ic_bt_imaging), this.IMAGING);
                default:
        ...
        if (btClass != null) {
            if (btClass.doesClassMatch(1)) {
                return new Pair<>(Integer.valueOf((int) R.drawable.ic_bt_headphones_a2dp), this.HEADPHONE);
            }
            if (btClass.doesClassMatch(0)) {
                return new Pair<>(Integer.valueOf((int) R.drawable.ic_bt_headset_hfp), this.HEADSET);
            }
        }
        return new Pair<>(Integer.valueOf((int) R.drawable.ic_settings_bluetooth), this.BLUETOOTH);
    }
}
