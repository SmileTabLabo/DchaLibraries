...
public abstract class ConfirmDeviceCredentialBaseFragment extends OptionsMenuFragment implements FingerprintUiHelper.Callback {
    ...
    private final Runnable mResetErrorRunnable = new Runnable() { // from class: com.android.settings.ConfirmDeviceCredentialBaseFragment.1
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        this.mCancelButton.setOnClickListener(new View.OnClickListener() { // from class: com.android.settings.ConfirmDeviceCredentialBaseFragment.2
    ...
    public void updateErrorMessage(int numAttempts) {
        ...
        if (remainingAttempts == 1) {
            ...
            showDialog(title, message, 17039370, false);
    ...
    private void showDialog(String title, String message, int buttonString, final boolean dismiss) {
        AlertDialog dialog = new AlertDialog.Builder(getActivity()).setTitle(title).setMessage(message).setPositiveButton(buttonString, new DialogInterface.OnClickListener() { // from class: com.android.settings.ConfirmDeviceCredentialBaseFragment.3
