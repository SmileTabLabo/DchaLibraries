...
public class InputMethodAndLanguageSettings extends SettingsPreferenceFragment implements Preference.OnPreferenceChangeListener, InputManager.InputDeviceListener, KeyboardLayoutDialogFragment.OnSetupKeyboardLayoutsListener, Indexable, InputMethodPreference.OnSavePreferenceListener {
    ...
    public static final Indexable.SearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider() { // from class: com.android.settings.inputmethod.InputMethodAndLanguageSettings.2
        ...
        public List<SearchIndexableRaw> getRawDataToIndex(Context context, boolean enabled) {
            ...
            if (InputMethodAndLanguageSettings.m943wrap0()) {
    ...
    static /* synthetic */ boolean m943wrap0() {
    ...
    public void onCreate(Bundle icicle) {
        ...
        if (spellChecker != null) {
            ...
            intent.putExtra(":settings:show_fragment_title_resid", (int) R.string.spellcheckers_settings_title);
    ...
    private void updateUserDictionaryPreference(Preference userDictionaryPreference) {
        ...
        if (localeSet == null) {
            ...
            userDictionaryPreference.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() { // from class: com.android.settings.inputmethod.InputMethodAndLanguageSettings.3
    ...
    private void updateInputMethodPreferenceViews() {
        ...
        synchronized (this.mInputMethodPreferenceList) {
            for (InputMethodPreference pref : this.mInputMethodPreferenceList) {
                this.mKeyboardSettingsCategory.removePreference(pref);
            }
            ...
            for (int i = 0; i < N; i++) {
                ...
                this.mInputMethodPreferenceList.add(new InputMethodPreference(context, imi, this.mShowsOnlyFullImeAndKeyboardList, z, this));
            }
    ...
    private void updateHardKeyboards() {
        ...
        for (int i : devices) {
            ...
            if (device != null && !device.isVirtual() && device.isFullKeyboard()) {
                ...
                pref.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() { // from class: com.android.settings.inputmethod.InputMethodAndLanguageSettings.5
                    @Override // android.support.v7.preference.Preference.OnPreferenceClickListener
