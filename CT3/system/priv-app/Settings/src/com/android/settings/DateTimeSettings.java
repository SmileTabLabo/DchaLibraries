...
public class DateTimeSettings extends SettingsPreferenceFragment implements TimePickerDialog.OnTimeSetListener, DatePickerDialog.OnDateSetListener, Preference.OnPreferenceChangeListener, DialogInterface.OnClickListener, DialogInterface.OnCancelListener {
    public static final SummaryLoader.SummaryProviderFactory SUMMARY_PROVIDER_FACTORY = new SummaryLoader.SummaryProviderFactory() { // from class: com.android.settings.DateTimeSettings.2
    ...
    public Dialog onCreateDialog(int id) {
        ...
        switch (id) {
            ...
            case 2:
                ...
                return new AlertDialog.Builder(getActivity()).setMessage(getActivity().getResources().getString(msg)).setTitle(R.string.proxy_error).setIcon(17301543).setPositiveButton(17039379, this).setNegativeButton(17039369, this).create();
            default:
