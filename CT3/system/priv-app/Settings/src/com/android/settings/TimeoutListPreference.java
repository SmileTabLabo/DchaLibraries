...
public class TimeoutListPreference extends RestrictedListPreference {
    ...
    public void onDialogCreated(Dialog dialog) {
        ...
        footerView.findViewById(R.id.admin_more_details_link).setOnClickListener(new View.OnClickListener() { // from class: com.android.settings.TimeoutListPreference.1
