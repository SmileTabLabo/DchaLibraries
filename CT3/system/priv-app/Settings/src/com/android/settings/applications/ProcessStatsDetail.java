...
public class ProcessStatsDetail extends SettingsPreferenceFragment {
    static final Comparator<ProcStatsEntry> sEntryCompare = new Comparator<ProcStatsEntry>() { // from class: com.android.settings.applications.ProcessStatsDetail.1
    ...
    static final Comparator<ProcStatsEntry.Service> sServiceCompare = new Comparator<ProcStatsEntry.Service>() { // from class: com.android.settings.applications.ProcessStatsDetail.2
        @Override // java.util.Comparator
    ...
    static final Comparator<PkgService> sServicePkgCompare = new Comparator<PkgService>() { // from class: com.android.settings.applications.ProcessStatsDetail.3
        @Override // java.util.Comparator
    ...
    private void updateRunningServices() {
        ...
        for (int i2 = 0; i2 < N2; i2++) {
            ...
            if ((runningService.started || runningService.clientLabel != 0) && (runningService.flags & 8) == 0 && (pref = this.mServiceMap.get((service = runningService.service))) != null) {
                pref.setOnCancelListener(new CancellablePreference.OnCancelListener() { // from class: com.android.settings.applications.ProcessStatsDetail.4
