...
public class Status extends SettingsPreferenceFragment {
    ...
    private final BroadcastReceiver mConnectivityReceiver = new BroadcastReceiver() { // from class: com.android.settings.deviceinfo.Status.2
        @Override // android.content.BroadcastReceiver
        public void onReceive(Context context, Intent intent) {
            String action = intent.getAction();
    ...
    private void setWifiStatus() {
        ...
        if (!TextUtils.isEmpty(macAddress)) {
            str = this.mExt.customizeMacAddressString(macAddress, this.mUnavailable);
        } else {
            str = this.mUnavailable;
        }
