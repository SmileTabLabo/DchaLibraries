...
public class AppNotificationSettings extends NotificationSettingsBase {
    ...
    @Override // com.android.settings.notification.NotificationSettingsBase, com.android.settings.SettingsPreferenceFragment, com.android.settings.InstrumentedPreferenceFragment, android.app.Fragment
    ...
    protected void updateDependents(int importance) {
        ...
        if (checkCanBeVisible(3, importance)) {
            z = !this.mDndVisualEffectsSuppressed;
        } else {
            z = false;
        }
