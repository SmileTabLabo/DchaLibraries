    ...
    public void update() {
        ...
        for (int userIndex = 0; userIndex < userCount; userIndex++) {
            ...
            if (isProfileOf(this.mCurrentUser, userInfo)) {
                ...
                addDetailItems(details, isMountedReadable, userInfo.id);
                addedUserCount++;
            }
        }
    ...
    public void onPrepareOptionsMenu(Menu menu) {
        ...
        if (isVolumeValid()) {
            ...
            if (privateVol != null && privateVol.getType() == 1 && !Objects.equals(this.mVolume, privateVol)) {
                z = StorageManagerEx.isSetPrimaryStorageUuidFinished();
            }
    ...
    public boolean onPreferenceTreeClick(Preference pref) {
        ...
        switch (itemTitleId) {
            case 0:
                ...
                return true;
            case R.string.storage_menu_explore /* 2131428654 */:
                intent = this.mSharedVolume.buildBrowseIntent();
                break;
            case R.string.storage_detail_apps /* 2131428685 */:
                Bundle args = new Bundle();
                ...
                break;
            case R.string.storage_detail_images /* 2131428686 */:
