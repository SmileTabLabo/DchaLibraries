...
public class ChooseLockPattern extends SettingsActivity {
    ...
    public static class ChooseLockPatternFragment extends InstrumentedFragment implements View.OnClickListener, SaveChosenLockWorkerBase.Listener {
        ...
        private static final /* synthetic */ int[] f2x9316aa93 = null;
        ...
        private static /* synthetic */ int[] m279xd0a3486f() {
            if (f2x9316aa93 != null) {
                return f2x9316aa93;
            }
        ...
        private void startSaveAndFinish() {
            ...
            setRightButtonEnabled(false);
            this.mSaveAndFinishWorker = new SaveAndFinishWorker(null);
            this.mSaveAndFinishWorker.setListener(this);
    ...
    public static class SaveAndFinishWorker extends SaveChosenLockWorkerBase {
        ...
        /* synthetic */ SaveAndFinishWorker(SaveAndFinishWorker saveAndFinishWorker) {
            this();
        }
        ...
        protected Intent saveAndVerifyInBackground() {
            ...
            try {
                bArr = this.mUtils.verifyPattern(this.mChosenPattern, this.mChallenge, userId);
            ...
            result.putExtra("hw_auth_token", bArr);
            return result;
        }
