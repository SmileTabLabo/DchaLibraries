...
public class SystemBarHelper {
    ...
    private static void addImmersiveFlagsToDecorView(Window window, final int vis) {
        getDecorView(window, new OnDecorViewInstalledListener() { // from class: com.android.setupwizardlib.util.SystemBarHelper.1
    ...
    public static class DecorViewFinder {
        ...
        /* synthetic */ DecorViewFinder(DecorViewFinder decorViewFinder) {
            this();
        }

        private DecorViewFinder() {
            this.mHandler = new Handler();
            this.mCheckDecorViewRunnable = new Runnable() { // from class: com.android.setupwizardlib.util.SystemBarHelper.DecorViewFinder.1
    ...
    private static void temporarilyDisableDialogFocus(final Window window) {
        ...
        new Handler().post(new Runnable() { // from class: com.android.setupwizardlib.util.SystemBarHelper.3
            @Override // java.lang.Runnable
            public void run() {
                window.clearFlags(8);
            }
    ...
    private static class WindowInsetsListener implements View.OnApplyWindowInsetsListener {
        ...
        /* synthetic */ WindowInsetsListener(WindowInsetsListener windowInsetsListener) {
            this();
        }
