...
public class NfcSettings extends SettingsPreferenceFragment implements Indexable {
    ...
    private final BroadcastReceiver mReceiver = new BroadcastReceiver() { // from class: com.mediatek.nfc.NfcSettings.1
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if ("android.nfc.action.ADAPTER_STATE_CHANGED".equals(action)) {
                ...
                NfcSettings.this.mQueryTask = new QueryTask(NfcSettings.this, null);
    ...
    private final ContentObserver mActiveCardModeObserver = new ContentObserver(new Handler()) { // from class: com.mediatek.nfc.NfcSettings.2
    ...
    private class QueryTask extends AsyncTask<Void, Void, Integer> {
        /* synthetic */ QueryTask(NfcSettings this$0, QueryTask queryTask) {
            this();
        }
