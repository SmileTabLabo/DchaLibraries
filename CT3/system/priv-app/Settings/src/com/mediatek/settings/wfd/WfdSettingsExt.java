...
public class WfdSettingsExt {
    ...
    private final BroadcastReceiver mReceiver = new BroadcastReceiver() { // from class: com.mediatek.settings.wfd.WfdSettingsExt.1
    ...
    public boolean addAdditionalPreference(PreferenceScreen preferenceScreen, boolean available) {
        ...
        if (this.mDevicePref == null) {
            ...
            if (this.mContext.getResources().getBoolean(17956953)) {
    ...
    public void handleWfdStatusChanged(WifiDisplayStatus status) {
        ...
        if (status == null) {
            ...
            bStateOn = status.getFeatureState() == 3;
        }
