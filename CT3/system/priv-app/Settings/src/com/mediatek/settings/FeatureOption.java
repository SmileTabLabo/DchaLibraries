...
public class FeatureOption {
    ...
    public static final boolean MTK_DISABLE_CAPABILITY_SWITCH = getValue("ro.mtk_disable_cap_switch");
    ...
    public static final boolean MTK_POWER_PERFORMANCE_STRATEGY_SUPPORT = getValue("ro.mtk_pow_perf_support");
