...
public class InputMethodExts {
    ...
    public static boolean displayVoiceWakeupAlert(final Context context, final String packageName) {
        if (packageName.equals("com.mediatek.voicecommand")) {
            ...
            if (cmdStatus == 0) {
                displayVoiceWakeupAlert(new DialogInterface.OnClickListener() { // from class: com.mediatek.settings.inputmethod.InputMethodExts.1
                ...
                }, new DialogInterface.OnClickListener() { // from class: com.mediatek.settings.inputmethod.InputMethodExts.2
                    @Override // android.content.DialogInterface.OnClickListener
                    public void onClick(DialogInterface dialog, int which) {
                    }
                }, context);
    ...
    private static void displayVoiceWakeupAlert(DialogInterface.OnClickListener positiveOnClickListener, final DialogInterface.OnClickListener negativeOnClickListener, Context context) {
        ...
        builder.setTitle(context.getString(R.string.voice_wakeup)).setMessage(context.getString(R.string.voice_wakeup_confirm)).setCancelable(true).setPositiveButton(17039370, positiveOnClickListener).setNegativeButton(17039360, negativeOnClickListener).setOnCancelListener(new DialogInterface.OnCancelListener() { // from class: com.mediatek.settings.inputmethod.InputMethodExts.3
