...
public final class WfdSinkSurfaceFragment extends DialogFragment implements SurfaceHolder.Callback, View.OnLongClickListener {
    ...
    public void addWfdSinkGuide() {
        ...
        btn.setOnClickListener(new View.OnClickListener() { // from class: com.mediatek.settings.wfd.WfdSinkSurfaceFragment.1
            ...
            public void run() {
                ...
                if (!WfdSinkSurfaceFragment.this.mCountdownShowing) {
                    ...
                    if (this.mCountDownNum <= 0) {
                        ...
                        return;
                    } else if (WfdSinkSurfaceFragment.this.mCountdownShowing && (countdownView = (ViewGroup) WfdSinkSurfaceFragment.this.mSinkViewLayout.getTag(R.id.wfd_sink_countdown_num)) != null && (tv = (TextView) countdownView.findViewById(R.id.wfd_sink_countdown_num)) != null) {
