...
public class ClearMotionSettings extends Activity implements CompoundButton.OnCheckedChangeListener, MediaPlayer.OnCompletionListener, MediaPlayer.OnPreparedListener, SurfaceHolder.Callback {
    ...
    private BroadcastReceiver mUpdateClearMotionStatusReceiver = new BroadcastReceiver() { // from class: com.mediatek.settings.ClearMotionSettings.1
    ...
    private MediaPlayer.OnErrorListener mErrorListener = new MediaPlayer.OnErrorListener() { // from class: com.mediatek.settings.ClearMotionSettings.2
