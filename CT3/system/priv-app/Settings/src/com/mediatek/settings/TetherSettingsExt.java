...
public class TetherSettingsExt implements Preference.OnPreferenceChangeListener {
    ...
    private BluetoothDun.ServiceListener mDunServiceListener = new BluetoothDun.ServiceListener() { // from class: com.mediatek.settings.TetherSettingsExt.1
