...
public class PhoneConfigurationSettings extends ListPreference implements Preference.OnPreferenceChangeListener {
    ...
    public PhoneConfigurationSettings(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.mIntentReceiver = new BroadcastReceiver() { // from class: com.mediatek.settings.PhoneConfigurationSettings.1
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        builder.setMessage(message).setIconAttribute(16843605).setPositiveButton(17039379, new DialogInterface.OnClickListener() { // from class: com.mediatek.settings.PhoneConfigurationSettings.2
            @Override // android.content.DialogInterface.OnClickListener
            public void onClick(DialogInterface dialog, int which) {
                PhoneConfigurationSettings.this.handleCarrierConfigChange();
            }
        }).setNegativeButton(17039369, new DialogInterface.OnClickListener() { // from class: com.mediatek.settings.PhoneConfigurationSettings.3
            @Override // android.content.DialogInterface.OnClickListener
            public void onClick(DialogInterface dialog, int which) {
                PhoneConfigurationSettings.this.setValue(PhoneConfigurationSettings.this.mUspManager.getActiveOpPack());
            }
        }).setOnCancelListener(new DialogInterface.OnCancelListener() { // from class: com.mediatek.settings.PhoneConfigurationSettings.4
