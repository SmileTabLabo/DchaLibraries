...
public class HdmiSettings extends SettingsPreferenceFragment implements Preference.OnPreferenceChangeListener {
    ...
    private BroadcastReceiver mActionReceiver = new BroadcastReceiver() { // from class: com.mediatek.hdmi.HdmiSettings.1
    ...
    private void showDialog() {
        ...
        this.mHDMIExcludeDialog = new AlertDialog.Builder(this.mContext).setMessage(messageString).setPositiveButton(mResource.getString(17040396), new DialogInterface.OnClickListener() { // from class: com.mediatek.hdmi.HdmiSettings.3
        ...
        }).setNegativeButton(mResource.getString(17040355), new DialogInterface.OnClickListener() { // from class: com.mediatek.hdmi.HdmiSettings.4
            @Override // android.content.DialogInterface.OnClickListener
            public void onClick(DialogInterface dialog, int which) {
        ...
        }).setOnCancelListener(new DialogInterface.OnCancelListener() { // from class: com.mediatek.hdmi.HdmiSettings.5
        ...
        }).setOnDismissListener(new DialogInterface.OnDismissListener() { // from class: com.mediatek.hdmi.HdmiSettings.6
