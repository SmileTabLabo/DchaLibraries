...
public class SoundEnhancement extends SettingsPreferenceFragment implements Indexable {
    ...
    public static boolean getBesSurroundState(AudioManager audioManager) {
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public static void setBesSurroundState(AudioManager audioManager, boolean state) {
        audioManager.setParameters(state ? BESSURROUND_ON : BESSURROUND_OFF);
    }

    /* JADX INFO: Access modifiers changed from: protected */
    public static int getBesSurroundMode(AudioManager audioManager) {
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public static void setBesSurroundMode(AudioManager audioManager, int mode) {
