...
public class ConfigureWifiSettingsExt {
    ...
    private final BroadcastReceiver mReceiver = new BroadcastReceiver() { // from class: com.mediatek.wifi.ConfigureWifiSettingsExt.1
                    ...
                    if (ipAddresses[i].indexOf(":") == -1) {
                        ...
                        if (ipAddresses[i] == null) {
                            ...
                            for (int j = 0; j < ipv6Addresses.length; j++) {
                                ipSummary = ipSummary + ipv6Addresses[j] + "\n";
                            }
                        }
