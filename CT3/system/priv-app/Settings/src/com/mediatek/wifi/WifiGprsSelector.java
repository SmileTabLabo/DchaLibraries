...
public class WifiGprsSelector extends WifiSettings implements Preference.OnPreferenceChangeListener {
    ...
    @Override // com.android.settings.wifi.WifiSettings, com.android.settings.RestrictedSettingsFragment, com.android.settings.SettingsPreferenceFragment, com.android.settings.InstrumentedPreferenceFragment, android.app.Fragment
    ...
    @Override // com.android.settings.wifi.WifiSettings, com.android.settings.InstrumentedPreferenceFragment, android.app.Fragment
    public void onPause() {
    ...
    private void fillList(int subId) {
        ...
        simReady = (this.mScreenEnable && this.mIsCallStateIdle && !this.mAirplaneModeEnabled) ? false : false;
    ...
    @Override // com.android.settings.wifi.WifiSettings, android.support.v14.preference.PreferenceFragment, android.support.v7.preference.PreferenceManager.OnPreferenceTreeClickListener
    public boolean onPreferenceTreeClick(Preference preference) {
        ...
        if ("data_enabler_gemini".equals(key)) {
            ...
            AlertDialog dialog = new AlertDialog.Builder(getPrefContext()).setSingleChoiceItems(mAdapter, this.mInitValue, new DialogInterface.OnClickListener() { // from class: com.mediatek.wifi.WifiGprsSelector.6
            ...
            }).setTitle(R.string.data_conn_category_title).setNegativeButton(17039369, new DialogInterface.OnClickListener() { // from class: com.mediatek.wifi.WifiGprsSelector.7
                @Override // android.content.DialogInterface.OnClickListener
                public void onClick(DialogInterface dialog2, int which) {
                }
            }).create();
    ...
    public Dialog onCreateDialog(int id) {
        ...
        if (id == 1001) {
            ...
            builder.setPositiveButton(simStatusStrings.get(2), new DialogInterface.OnClickListener() { // from class: com.mediatek.wifi.WifiGprsSelector.8
                @Override // android.content.DialogInterface.OnClickListener
                public void onClick(DialogInterface dialog2, int which) {
                    WifiGprsSelector.this.mCellConnMgr.handleRequest(WifiGprsSelector.this.mSelectedDataSubId, 4);
                }
            });
            builder.setNegativeButton(simStatusStrings.get(3), new DialogInterface.OnClickListener() { // from class: com.mediatek.wifi.WifiGprsSelector.9
                @Override // android.content.DialogInterface.OnClickListener
                public void onClick(DialogInterface dialog2, int which) {
                }
            });
