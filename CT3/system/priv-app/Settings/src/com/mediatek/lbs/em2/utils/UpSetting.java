...
public class UpSetting {
    ...
    public String toString() {
        String ret;
        String ret2;
        String ret3 = "caEnable=[" + this.caEnable + "] ";
        String ret4 = (ret3 + "niRequest=[" + this.niRequest + "] ") + "roaming=[" + this.roaming + "] ";
        if (this.cdmaPreferred == 0) {
            ret = ret4 + "cdmaPreferred=[WCDMA] ";
        } else if (this.cdmaPreferred == 1) {
            ret = ret4 + "cdmaPreferred=[CDMA] ";
        } else if (this.cdmaPreferred == 2) {
            ret = ret4 + "cdmaPreferred=[CDMA_FORCE] ";
        } else {
            ret = ret4 + "cdmaPreferred=[UNKNOWN " + this.cdmaPreferred + "] ";
        }
