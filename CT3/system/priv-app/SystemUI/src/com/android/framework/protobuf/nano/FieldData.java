...
/* loaded from: a.zip:com/android/framework/protobuf/nano/FieldData.class */
class FieldData implements Cloneable {
    ...
    /* renamed from: clone */
    public final FieldData m573clone() {
        ...
        try {
            ...
            if (this.value != null) {
                if (this.value instanceof MessageNano) {
                    fieldData.value = ((MessageNano) this.value).m575clone();
                    ...
                    for (int i2 = 0; i2 < messageNanoArr.length; i2++) {
                        messageNanoArr2[i2] = messageNanoArr[i2].m575clone();
                    }
                }
            }
            return fieldData;
