...
/* loaded from: a.zip:com/android/systemui/recents/views/TaskViewTransform.class */
public class TaskViewTransform {
    ...
    public boolean hasAlphaChangedFrom(float f) {
        boolean z = false;
        if (Float.compare(this.alpha, f) != 0) {
            z = true;
        }
        return z;
    }
    ...
    public boolean hasRectChangedFrom(View view) {
        boolean z = true;
        if (((int) this.rect.left) == view.getLeft()) {
            if (((int) this.rect.right) != view.getRight()) {
                z = true;
            } else {
                z = true;
                if (((int) this.rect.top) == view.getTop()) {
                    z = true;
                    if (((int) this.rect.bottom) == view.getBottom()) {
                        z = false;
                    }
                }
            }
    ...
    public boolean hasTranslationZChangedFrom(float f) {
        boolean z = false;
        if (Float.compare(this.translationZ, f) != 0) {
            z = true;
        }
        return z;
    }
    ...
    public boolean isSame(TaskViewTransform taskViewTransform) {
        return (this.translationZ == taskViewTransform.translationZ && this.scale == taskViewTransform.scale && taskViewTransform.alpha == this.alpha && this.dimAlpha == taskViewTransform.dimAlpha && this.visible == taskViewTransform.visible) ? this.rect.equals(taskViewTransform.rect) : false;
    }
