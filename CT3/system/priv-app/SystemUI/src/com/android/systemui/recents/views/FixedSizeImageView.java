...
/* loaded from: a.zip:com/android/systemui/recents/views/FixedSizeImageView.class */
public class FixedSizeImageView extends AlphaOptimizedImageView {
    ...
    public void setImageDrawable(Drawable drawable) {
        boolean z = drawable instanceof BitmapDrawable ? ((BitmapDrawable) drawable).getBitmap() == null : false;
        if (drawable == null || z) {
