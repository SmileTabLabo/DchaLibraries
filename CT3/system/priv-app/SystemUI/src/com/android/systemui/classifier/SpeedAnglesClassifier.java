...
/* loaded from: a.zip:com/android/systemui/classifier/SpeedAnglesClassifier.class */
public class SpeedAnglesClassifier extends StrokeClassifier {
    private HashMap<Stroke, Data> mStrokeMap = new HashMap<>();

    /* loaded from: a.zip:com/android/systemui/classifier/SpeedAnglesClassifier$Data.class */
