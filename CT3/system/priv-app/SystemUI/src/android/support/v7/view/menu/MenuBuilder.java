...
/* loaded from: a.zip:android/support/v7/view/menu/MenuBuilder.class */
public class MenuBuilder implements Menu {
    ...
    /* loaded from: a.zip:android/support/v7/view/menu/MenuBuilder$Callback.class */
    ...
    /* loaded from: a.zip:android/support/v7/view/menu/MenuBuilder$ItemInvoker.class */
    ...
    private void setShortcutsVisibleInner(boolean z) {
        this.mShortcutsVisible = (!z || this.mResources.getConfiguration().keyboard == 1) ? false : this.mResources.getBoolean(R$bool.abc_config_showMenuShortcutsWhenKeyboardPresent);
    }
    ...
    public boolean dispatchMenuItemSelected(MenuBuilder menuBuilder, MenuItem menuItem) {
        return this.mCallback != null ? this.mCallback.onMenuItemSelected(menuBuilder, menuItem) : false;
    }
