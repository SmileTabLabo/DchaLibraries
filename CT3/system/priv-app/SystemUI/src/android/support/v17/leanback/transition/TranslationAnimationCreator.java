...
/* loaded from: a.zip:android/support/v17/leanback/transition/TranslationAnimationCreator.class */
class TranslationAnimationCreator {

    /* loaded from: a.zip:android/support/v17/leanback/transition/TranslationAnimationCreator$TransitionPositionListener.class */
    private static class TransitionPositionListener extends AnimatorListenerAdapter implements Transition.TransitionListener {
        ...
        /* synthetic */ TransitionPositionListener(View view, View view2, int i, int i2, float f, float f2, TransitionPositionListener transitionPositionListener) {
    ...
    public static Animator createAnimation(View view, TransitionValues transitionValues, int i, int i2, float f, float f2, float f3, float f4, TimeInterpolator timeInterpolator, Transition transition) {
        ...
        TransitionPositionListener transitionPositionListener = new TransitionPositionListener(view, transitionValues.view, i + round, i2 + round2, translationX, translationY, null);
