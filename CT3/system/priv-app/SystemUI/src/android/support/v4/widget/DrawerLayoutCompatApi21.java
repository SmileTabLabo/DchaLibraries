...
/* loaded from: a.zip:android/support/v4/widget/DrawerLayoutCompatApi21.class */
class DrawerLayoutCompatApi21 {
    private static final int[] THEME_ATTRS = {16843828};

    /* loaded from: a.zip:android/support/v4/widget/DrawerLayoutCompatApi21$InsetsListener.class */
    static class InsetsListener implements View.OnApplyWindowInsetsListener {
        ...
        public WindowInsets onApplyWindowInsets(View view, WindowInsets windowInsets) {
            ...
            drawerLayoutImpl.setChildInsets(windowInsets, z);
