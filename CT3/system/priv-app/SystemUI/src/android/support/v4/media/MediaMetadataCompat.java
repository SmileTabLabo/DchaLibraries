...
/* loaded from: a.zip:android/support/v4/media/MediaMetadataCompat.class */
public final class MediaMetadataCompat implements Parcelable {
    ...
    /* loaded from: a.zip:android/support/v4/media/MediaMetadataCompat$BitmapKey.class */
    public @interface BitmapKey {
    }

    @Retention(RetentionPolicy.SOURCE)
    /* loaded from: a.zip:android/support/v4/media/MediaMetadataCompat$TextKey.class */
