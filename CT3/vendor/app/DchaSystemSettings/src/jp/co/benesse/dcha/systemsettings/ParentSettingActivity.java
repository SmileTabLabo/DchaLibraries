...
/* loaded from: s.zip:jp/co/benesse/dcha/systemsettings/ParentSettingActivity.class */
public class ParentSettingActivity extends Activity {
    private IDchaService mDchaService;
    private ServiceConnection mDchaServiceConnection = new ServiceConnection(this) { // from class: jp.co.benesse.dcha.systemsettings.ParentSettingActivity.1
        final ParentSettingActivity this$0;
    ...
    public boolean isApplicationForeground() {
        ...
        try {
            ...
            if (packageName != null) {
                z = false;
                if (packageName.startsWith("jp.co.benesse")) {
