...
/* loaded from: s.zip:jp/co/benesse/dcha/systemsettings/WifiTracker.class */
public class WifiTracker {
    ...
    /* loaded from: s.zip:jp/co/benesse/dcha/systemsettings/WifiTracker$MainHandler.class */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* loaded from: s.zip:jp/co/benesse/dcha/systemsettings/WifiTracker$Multimap.class */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* loaded from: s.zip:jp/co/benesse/dcha/systemsettings/WifiTracker$Scanner.class */
    public class Scanner extends Handler {
        private int mRetry;
        final WifiTracker this$0;

        private Scanner(WifiTracker wifiTracker) {
            this.this$0 = wifiTracker;
            this.mRetry = 0;
        }

        /* synthetic */ Scanner(WifiTracker wifiTracker, Scanner scanner) {
            this(wifiTracker);
        }
            ...
            if (this.this$0.mWifiManager.startScan()) {
                ...
                if (i >= 3) {
                    ...
                    if (this.this$0.mContext != null) {
                        Toast.makeText(this.this$0.mContext, 2131230933, 1).show();
                        return;
                    }
                    return;
                }
    ...
    /* loaded from: s.zip:jp/co/benesse/dcha/systemsettings/WifiTracker$WifiListener.class */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* loaded from: s.zip:jp/co/benesse/dcha/systemsettings/WifiTracker$WifiTrackerNetworkCallback.class */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* loaded from: s.zip:jp/co/benesse/dcha/systemsettings/WifiTracker$WorkHandler.class */
    ...
    private WifiTracker(Context context, WifiListener wifiListener, Looper looper, boolean z, boolean z2, boolean z3, WifiManager wifiManager, ConnectivityManager connectivityManager, Looper looper2) {
        ...
        this.mScanId = 0;
        this.mReceiver = new BroadcastReceiver(this) { // from class: jp.co.benesse.dcha.systemsettings.WifiTracker.1
            final WifiTracker this$0;
        ...
        this.mMainHandler = new MainHandler(this, looper3);
        this.mWorkHandler = new WorkHandler(this, looper != null ? looper : looper3);
