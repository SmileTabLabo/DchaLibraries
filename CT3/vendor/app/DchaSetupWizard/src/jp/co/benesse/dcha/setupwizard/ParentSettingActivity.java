...
public abstract class ParentSettingActivity extends Activity {
    ...
    protected ServiceConnection mDchaServiceConnectionParent = new ServiceConnection() { // from class: jp.co.benesse.dcha.setupwizard.ParentSettingActivity.1
    ...
    public void moveIntroductionSettingActivity() {
        ...
        try {
            ...
            Intent intent = new Intent(this, IntroductionSettingActivity.class);
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public void callSystemErrorDialog(String msg) {
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public boolean setSetupStatus(int status) {
        try {
