...
public class FileDownloadRequest extends Request {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    @Override // jp.co.benesse.dcha.setupwizard.http.Request
    public void onSendData(HttpURLConnection conn) throws IOException {
    ...
    */
    public Response onReceiveData(HttpURLConnection conn, Response response) throws IOException {
        Throwable th;
        int length;
        ...
        if (!outPath.exists()) {
            ...
            try {
                ...
                while (!request.isCancelled() && (length = istream.read(buff)) != -1) {
                    ...
                    downloadResponse.receiveLength += length;
