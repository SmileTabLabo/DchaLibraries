...
public class DchaDialog extends DialogFragment {
    ...
    protected void dialogWifiDisconnected(Dialog dialog) {
        ...
        okBtn.setOnClickListener(new View.OnClickListener() { // from class: jp.co.benesse.dcha.setupwizard.DchaDialog.1
    ...
    protected void dialogSystemError(Dialog dialog) {
        ...
        okBtn.setOnClickListener(new View.OnClickListener() { // from class: jp.co.benesse.dcha.setupwizard.DchaDialog.2
            @Override // android.view.View.OnClickListener
            public void onClick(View v) {
    ...
    protected void dialogNetworkError(Dialog dialog) {
        ...
        final ImageView okBtn = (ImageView) dialog.findViewById(R.id.ok_btn);
        okBtn.setOnClickListener(new View.OnClickListener() { // from class: jp.co.benesse.dcha.setupwizard.DchaDialog.3
            @Override // android.view.View.OnClickListener
            public void onClick(View v) {
