...
public class HttpThread extends Thread {
                    ...
                    try {
                        ...
                        if (response != null) {
                            ...
                            try {
                                ...
                                this.mRetryWaitCondition.await(request.retryInterval * requestCount, TimeUnit.MILLISECONDS);
    ...
    protected Response newResponseInstance(Class<? extends Response> cls) {
        ...
        try {
            ...
            Constructor<? extends Response> constructor = cls.getConstructor(types);
