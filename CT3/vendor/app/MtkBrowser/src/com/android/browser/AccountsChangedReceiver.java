...
/* loaded from: b.zip:com/android/browser/AccountsChangedReceiver.class */
public class AccountsChangedReceiver extends BroadcastReceiver {
    private static final String[] PROJECTION = {"account_name", "account_type"};

    /* loaded from: b.zip:com/android/browser/AccountsChangedReceiver$DeleteRemovedAccounts.class */
