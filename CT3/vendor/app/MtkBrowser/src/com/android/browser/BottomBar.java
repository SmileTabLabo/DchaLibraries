...
/* loaded from: b.zip:com/android/browser/BottomBar.class */
public class BottomBar extends LinearLayout {
    ...
    public BottomBar(Context context, UiController uiController, BaseUi baseUi, TabControl tabControl, FrameLayout frameLayout) {
        super(context, null);
        this.mHideBottomBarAnimatorListener = new Animator.AnimatorListener(this) { // from class: com.android.browser.BottomBar.1
    ...
    private void initLayout(Context context) {
        ...
        this.mBottomBarBack.setOnClickListener(new View.OnClickListener(this) { // from class: com.android.browser.BottomBar.2
            final BottomBar this$0;
        ...
        this.mBottomBarBack.setOnLongClickListener(new View.OnLongClickListener(this) { // from class: com.android.browser.BottomBar.3
            final BottomBar this$0;
            ...
            public boolean onLongClick(View view) {
                Toast.makeText(this.this$0.mUiController.getActivity(), this.this$0.mUiController.getActivity().getResources().getString(2131492983), 0).show();
                return false;
            }
        });
        this.mBottomBarForward.setOnClickListener(new View.OnClickListener(this) { // from class: com.android.browser.BottomBar.4
            final BottomBar this$0;
        ...
        this.mBottomBarForward.setOnLongClickListener(new View.OnLongClickListener(this) { // from class: com.android.browser.BottomBar.5
            final BottomBar this$0;
        ...
        this.mBottomBarTabs.setOnClickListener(new View.OnClickListener(this) { // from class: com.android.browser.BottomBar.6
            final BottomBar this$0;
        ...
        this.mBottomBarTabs.setOnLongClickListener(new View.OnLongClickListener(this) { // from class: com.android.browser.BottomBar.7
            final BottomBar this$0;
        ...
        this.mBottomBarBookmarks.setOnClickListener(new View.OnClickListener(this) { // from class: com.android.browser.BottomBar.8
            final BottomBar this$0;
        ...
        this.mBottomBarBookmarks.setOnLongClickListener(new View.OnLongClickListener(this) { // from class: com.android.browser.BottomBar.9
            final BottomBar this$0;
            ...
            @Override // android.view.View.OnLongClickListener
            public boolean onLongClick(View view) {
                Toast.makeText(this.this$0.mUiController.getActivity(), this.this$0.mUiController.getActivity().getResources().getString(2131493025), 0).show();
                return false;
            }
        });
        this.mBottomBarTabCount.setText(Integer.toString(this.mUiController.getTabControl().getTabCount()));
        this.mTabControl.setOnTabCountChangedListener(new TabControl.OnTabCountChangedListener(this) { // from class: com.android.browser.BottomBar.10
            final BottomBar this$0;
