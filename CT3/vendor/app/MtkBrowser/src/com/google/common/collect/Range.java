...
@GwtCompatible
/* loaded from: b.zip:com/google/common/collect/Range.class */
public final class Range<C extends Comparable> implements Predicate<C>, Serializable {

    /* renamed from: -com-google-common-collect-BoundTypeSwitchesValues  reason: not valid java name */
    private static final int[] f8comgooglecommoncollectBoundTypeSwitchesValues = null;
    ...
    private static /* synthetic */ int[] m432getcomgooglecommoncollectBoundTypeSwitchesValues() {
        if (f8comgooglecommoncollectBoundTypeSwitchesValues != null) {
            return f8comgooglecommoncollectBoundTypeSwitchesValues;
        }
        ...
        f8comgooglecommoncollectBoundTypeSwitchesValues = iArr;
        return iArr;
    }
    ...
    public static <C extends Comparable<?>> Range<C> downTo(C c, BoundType boundType) {
        switch (m432getcomgooglecommoncollectBoundTypeSwitchesValues()[boundType.ordinal()]) {
            case 1:
                return atLeast(c);
            case 2:
