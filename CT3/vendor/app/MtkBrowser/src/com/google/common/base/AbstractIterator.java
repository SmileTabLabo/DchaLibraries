...
@GwtCompatible
/* loaded from: b.zip:com/google/common/base/AbstractIterator.class */
abstract class AbstractIterator<T> implements Iterator<T> {
    ...
    /* loaded from: b.zip:com/google/common/base/AbstractIterator$State.class */
    public enum State {
        READY,
        NOT_READY,
        DONE,
    ...
    private static /* synthetic */ int[] m373getcomgooglecommonbaseAbstractIterator$StateSwitchesValues() {
    ...
    public final boolean hasNext() {
        ...
        switch (m373getcomgooglecommonbaseAbstractIterator$StateSwitchesValues()[this.state.ordinal()]) {
            case 1:
                return false;
            case 2:
                return true;
